...
/**
 * Paxos simulation test with mutation tracking and witnesses enabled.
 *
 * Note: Topology changes are disabled (--cluster-actions "") because
 * they are not currently supported with witnesses. We use
 ...
 */
public class ShortPaxosWitnessesSimulationTest
{
    @Test
