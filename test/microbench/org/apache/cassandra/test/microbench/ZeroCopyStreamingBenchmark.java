...
public class ZeroCopyStreamingBenchmark
{
    ...
    public static class BenchmarkState
    {
        ...
        public void setupBenchmark() throws IOException
        {
            ...
            ByteBufDataOutputStreamPlus out = ByteBufDataOutputStreamPlus.create(blockStreamCaptureChannel, 1024 * 1024, throwable -> {}, 30, TimeUnit.SECONDS);
            ...
            partialStreamWriter.write(ByteBufDataOutputStreamPlus.create(partialStreamChannel, 1024 * 1024, throwable -> {}, 30, TimeUnit.SECONDS));
