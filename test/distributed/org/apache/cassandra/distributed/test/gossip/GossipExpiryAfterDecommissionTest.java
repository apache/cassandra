...
public class GossipExpiryAfterDecommissionTest extends GossipExpiryTestBase
{
    ...
    {
        // Decommission one peer. Before shutting down messaging, the leaving node will gossip its final LEFT
        // status, including the expiry time it calculated to the remaining members.
