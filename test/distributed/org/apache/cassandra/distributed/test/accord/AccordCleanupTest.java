...
public class AccordCleanupTest extends AccordTestBase
{
    private static final Logger logger = LoggerFactory.getLogger(AccordCleanupTest.class);
    ...
    @Test
    public void accordUserDefinedCleanupTest() throws Throwable
    {
        ...
        test("CREATE TABLE " + qualifiedTableName + " (k int PRIMARY KEY, v int) WITH transactional_mode='full'", cluster -> {
            ...
            cluster.get(1).runOnInstance(() -> {
                String dataFile = getOnlyElement(Keyspace.open(KEYSPACE).getColumnFamilyStore(tableName).getLiveSSTables()).getFilename();
                CompactionManager.instance.forceUserDefinedCleanup(dataFile);
            });
    ...
    public void accordNodetoolCleanupPartialSSTableTest() throws Throwable
    {
        ...
        test("CREATE TABLE " + qualifiedTableName + " (k int PRIMARY KEY, v int) WITH transactional_mode='full'", cluster -> {
            setupForCleanupPartialSSTableTest(cluster, tableName, qualifiedTableName);
    ...
    @Test
    public void accordUserDefinedCleanupPartialSSTableTest() throws Throwable
    {
    ...
    public void accordNodetoolCleanupRangeInUseTest() throws Throwable
    {
        ...
        test("CREATE TABLE " + qualifiedTableName + " (k int PRIMARY KEY, v int) WITH transactional_mode='full'", cluster -> {
            setupForCleanupRangeInUseTest(cluster, tableName, qualifiedTableName);
    ...
    @Test
    public void accordUserDefinedCleanupRangeInUseTest() throws Throwable
    {
    ...
    public void nodetoolCleanupForNonAccordTableTest() throws Throwable
    {
        ...
        test("CREATE TABLE " + qualifiedTableName + " (k int PRIMARY KEY, v int)", cluster -> {
            setupForCleanupForNonAccordTableTest(cluster, tableName, qualifiedTableName);
    ...
    @Test
    public void userDefinedCleanupForNonAccordTableTest() throws Throwable
    {
    ...
    private void setupForCleanupTest(Cluster cluster, String tableName, String qualifiedTableName)
    {
    ...
    private void setupForCleanupPartialSSTableTest(Cluster cluster, String tableName, String qualifiedTableName)
    {
        cluster.coordinator(1).execute(wrapInTxn("INSERT INTO " + qualifiedTableName + " (k, v) VALUES (?, ?)"), ConsistencyLevel.SERIAL, 1, 2);
    ...
    private void setupForCleanupRangeInUseTest(Cluster cluster, String tableName, String qualifiedTableName)
    {
        cluster.coordinator(1).execute(wrapInTxn("INSERT INTO " + qualifiedTableName + " (k, v) VALUES (?, ?)"), ConsistencyLevel.SERIAL, 1, 2);
    ...
    private void setupForCleanupForNonAccordTableTest(Cluster cluster, String tableName, String qualifiedTableName)
    {
