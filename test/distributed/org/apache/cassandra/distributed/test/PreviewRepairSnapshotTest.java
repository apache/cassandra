...
public class PreviewRepairSnapshotTest extends TestBaseImpl
{
    ...
    public void testSnapshot() throws IOException
    {
                                                                     ...
                                                                     .with(NETWORK)).start()))
        {
            ...
            cluster.get(1).nodetoolResult("repair", "-vd", "-pr", KEYSPACE, "tbl").asserts().success().stdoutContains("Repaired data is in sync");
            ...
            cluster.get(1).nodetoolResult("repair", "-vd",
                                           KEYSPACE, "tbl").asserts().success().stdoutContains("Repaired data is inconsistent");
