...
public class AutoRepairSchedulerDisallowParallelReplicaRepairAcrossSchedulesTest extends TestBaseImpl
{
    ...
    public static void init() throws IOException
    {
        ...
        Map<String, String> irCofig = new HashMap<>();
        irCofig.put("initial_scheduler_delay", "5s");
        irCofig.put("enabled", "true");
        irCofig.put("parallel_repair_count", "3");
        irCofig.put("allow_parallel_replica_repair", "false");
        irCofig.put("allow_parallel_replica_repair_across_schedules", "false");
        irCofig.put("min_repair_interval", "5s");
