...
public class AutoRepairNoBootstrapRepairOnAddNodeTest extends TestBaseImpl
{
    @Test
    public void invokeBootstrapRepairE2E() throws Throwable
    {
        ...
        try (Cluster cluster = builder().withNodes(originalNodeCount)
                                        ...
                                        .withInstanceInitializer(AutoRepairNoBootstrapRepairOnAddNodeTest.BBStreamFailure::install)
                                        .start())
        {
            ...
            // bootstrap repair should not be run for Graceful replacement("cassandra.replace_address" is not set)
    ...
    public static class BBStreamFailure
    {
        ...
        public static void install(ClassLoader cl, Integer i)
        {
            new ByteBuddy().rebase(StreamSession.class)
                           ...
                           .intercept(MethodDelegation.to(AutoRepairNoBootstrapRepairOnAddNodeTest.BBStreamFailure.class))
                           .make()
