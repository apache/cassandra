...
public class SlowQueryDeserTest
{
    ...
    public void testSlowQueryDeser() throws Throwable
    {
        SlowOperation slowOperation = new SlowOperation(new MonitorableImpl()
        {
            ...
            public String name()
            {
                return String.format("select * from %s.%s where id = 5", monitoredOnKeyspace(), monitoredOnTable());
            }
        ...
        String serialize = MonitoringTask.Operation.serialize(List.of(slowOperation));
        Collection<MonitoringTask.Operation> deserialize = MonitoringTask.Operation.deserialize(serialize);
    }
}
