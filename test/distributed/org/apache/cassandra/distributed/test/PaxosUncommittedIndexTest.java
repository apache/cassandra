...
public class PaxosUncommittedIndexTest extends TestBaseImpl
{
    ...
    public void indexCqlIsExportableAndParsableTest() throws Throwable
    {
        ...
        {
            try (com.datastax.driver.core.Cluster clientCluster = com.datastax.driver.core.Cluster.builder().addContactPoint("127.0.0.1").withPort(dtestCluster.getNativeTransportForNode("127.0.0.1")).build())
            {
