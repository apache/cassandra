...
public class ReadRepairSliceQueriesTest extends ReadRepairQueryTester
{
    ...
    {
        MutationTrackingUtils.fixmeSkipIfLogged(replicationType, "Depends on short read protection and ReplicaFilteringProtection");
    ...
    {
        MutationTrackingUtils.fixmeSkipIfLogged(replicationType, "Depends on short read protection");
