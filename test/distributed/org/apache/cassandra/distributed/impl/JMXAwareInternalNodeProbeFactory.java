...
public class JMXAwareInternalNodeProbeFactory implements INodeProbeFactory
{
    private final boolean withNotifications;
    private final IInstanceConfig config;

    public JMXAwareInternalNodeProbeFactory(IInstanceConfig config, boolean withNotifications)
    {
        this.config = config;
    ...
    private class InternalNodeProbe extends NodeProbe
    {
        ...
        {
            jmxc = JMXUtil.getJmxConnector(JMXAwareInternalNodeProbeFactory.this.config);
        }
    }
}
