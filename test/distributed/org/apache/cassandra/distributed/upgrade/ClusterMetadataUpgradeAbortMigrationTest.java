...
public class ClusterMetadataUpgradeAbortMigrationTest extends UpgradeTestBase
{
    ...
    public void upgradeLostNotifyTest() throws Throwable
    {
        ...
        .runAfterClusterUpgrade((cluster) -> {
            ...
            cluster.get(1).nodetoolResult("cms", "abortinitialization", "--initiator", "127.0.0.1").asserts().failure();
            // but not on node2
            cluster.get(2).nodetoolResult("cms", "abortinitialization", "--initiator", "127.0.0.1").asserts().success();
