...
public class MathFctsUtilTest
{
    ...
    {
        assertFctEquals(MathFctsUtil.absFct(inputType), expected, inputType, inputValue);
    }
    ...
    {
        assertFctEquals(MathFctsUtil.expFct(inputType), expected, inputType, inputValue);
    }
    ...
    {
        assertFctEquals(MathFctsUtil.logFct(inputType), expected, inputType, inputValue);
    }

    private <T extends Number> void assertLogEquals(T expected, NumberType<T> inputType, T inputValue, double delta)
    {
        assertFctEquals(MathFctsUtil.logFct(inputType), expected, inputType, inputValue, delta);
    }
    ...
    {
        assertFctEquals(MathFctsUtil.log10Fct(inputType), expected, inputType, inputValue);
    }

    private <T extends Number> void assertLog10Equals(T expected, NumberType<T> inputType, T inputValue, double delta)
    {
        assertFctEquals(MathFctsUtil.log10Fct(inputType), expected, inputType, inputValue, delta);
    }
    ...
    {
        assertFctEquals(MathFctsUtil.roundFct(inputType), expected, inputType, inputValue);
    }
    ...
    private <T extends Number> void assertFctEquals(ScalarFunction fct, T expected, NumberType<T> inputType, T inputValue, double delta)
    {
        ByteBuffer input = inputType.decompose(inputValue);
