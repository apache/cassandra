...
public class DescribeStatementTest extends CQLTester
{
    ...
    public void testDescribeRoundtrip() throws Throwable
    {
        for (String withInternals : new String[]{"", " WITH INTERNALS"})
        {
            ...
            String mvCreateView = executeDescribeNet(KEYSPACE, "DESCRIBE MATERIALIZED VIEW " + table + "_view").all()
                .get(0).getString("create_statement");
            ...
            String mvCreateView2 = executeDescribeNet(KEYSPACE, "DESCRIBE MATERIALIZED VIEW " + table + "_view").all()
                .get(0).getString("create_statement");
