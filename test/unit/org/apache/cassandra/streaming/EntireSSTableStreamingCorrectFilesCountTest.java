...
public class EntireSSTableStreamingCorrectFilesCountTest
{
    ...
    public void test() throws Exception
    {
        ...
        assertEquals(totalNumberOfFiles, CassandraOutgoingFile.getComponentManifest(sstable).components().size());

        assertEquals(totalNumberOfFiles, streamEventHandler.fileNames.size());
    }
    ...
    private static final class FileCountingStreamEventHandler implements StreamEventHandler
    {
        ...
        public void onSuccess(@Nullable StreamState streamState)
        {
            ...
            Assert.assertFalse(streamState.hasFailedSession());
        }
