...
public class MemtableAllocatorAwaitRoomTest
{
    ...
    {
        SlabPool pool = new SlabPool(1 << 20, 0, 1.0f, () -> CompletableFuture.completedFuture(true));
        try
        {
    ...
    {
        SlabPool pool = new SlabPool(1 << 20, 1 << 20, 1.0f, () -> CompletableFuture.completedFuture(true));
        try
        {
            MemtableAllocator allocator = pool.newAllocator();
            OpOrder.Group g = new OpOrder().start();
