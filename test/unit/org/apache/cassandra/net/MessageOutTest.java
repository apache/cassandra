...
{
    private static OutboundConnectionIdentifier connectionId;

    @BeforeClass
    public static void before() throws UnknownHostException
    {
        DatabaseDescriptor.daemonInitialization();
        connectionId = OutboundConnectionIdentifier.small(InetAddressAndPort.getByNameOverrideDefaults("127.0.0.1", 0),
    ...
    public void captureTracingInfo_ForceException()
    {
        ...
        message.captureTracingInfo(connectionId);
    }
