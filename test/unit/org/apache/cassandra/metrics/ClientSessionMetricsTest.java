...
public class ClientSessionMetricsTest
{
    ...
    public void testClientSessionMetrics()
    {
        ...
        long beforeCount = ClientSessionMetricsManager.getSessionMetrics(serviceName, tenancy, tier, driverName, enforcementLevelString, isDriverSupportedString, isAuthenticated).sessions.getCount();
        ClientSessionMetricsManager.getSessionMetrics(serviceName, tenancy, tier, driverName, enforcementLevelString, isDriverSupportedString, isAuthenticated).sessions.mark();
        long curCount = ClientSessionMetricsManager.getSessionMetrics(serviceName, tenancy, tier, driverName, enforcementLevelString, isDriverSupportedString, isAuthenticated).sessions.getCount();
