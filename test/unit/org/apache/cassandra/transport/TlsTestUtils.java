...
public class TlsTestUtils
{
    ...
    public static String SERVER_KEYSTORE_PASSWORD_FILE = "test/conf/cassandra_ssl_test.keystore.passwordfile";
    ...
    public static String SERVER_OUTBOUND_KEYSTORE_PASSWORD_FILE = "test/conf/cassandra_ssl_test_outbound.keystore.passwordfile";
    ...
    public static String SERVER_TRUSTSTORE_PASSWORD_FILE = "test/conf/cassandra_ssl_test.truststore.passwordfile";
