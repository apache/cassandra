...
public class InflightRequestPayloadTrackerTest extends CQLTester
{
    ...
    @Test
    public void testQueryExecutionWithOverloadedExceptionDisabledAndInflightLimitedExceeded() throws Throwable
    {
        SimpleClient client = new SimpleClient(nativeAddr.getHostAddress(),
                                               nativePort,
                                               ProtocolVersion.V5,
        ...
        try
        {
            ...
            DatabaseDescriptor.setMaxInflightRequestsPayloadPerEndpointInBytes(200);
            queryMessage = new QueryMessage("INSERT INTO atable (pk, v) VALUES (1, '')",
                                            queryOptions);
            client.execute(queryMessage);
        }
        finally
        {
            DatabaseDescriptor.setMaxInflightRequestsPayloadPerEndpointInBytes(3000000000L);
            client.close();
        }
    }
    ...
    public void testOverloadedExceptionForEndpointInflightLimit() throws Throwable
    {
        ...
        try
        {
            ...
            DatabaseDescriptor.setMaxInflightRequestsPayloadPerEndpointInBytes(600);
    ...
    public void testOverloadedExceptionForOverallInflightLimit() throws Throwable
    {
        ...
        try
        {
            ...
            // set total inflight limit low enough to have further request discarded
            DatabaseDescriptor.setMaxInflightGlobalRequestsPayloadInBytes(600);
            queryMessage = new QueryMessage("INSERT INTO atable (pk, v) VALUES (1, '')",
                                            queryOptions);
            try
            {
        ...
        {
            DatabaseDescriptor.setMaxInflightGlobalRequestsPayloadInBytes(5000000000L);
            client.close();
        }
    }
}