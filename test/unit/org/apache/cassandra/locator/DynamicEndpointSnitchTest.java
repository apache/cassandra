...
public class DynamicEndpointSnitchTest
{
    ...
    private static ReplicaList full(InetAddressAndPort... endpoints)
    {
        ReplicaList rlist = new ReplicaList(endpoints.length);
    ...
    public void testSnitch() throws InterruptedException, IOException, ConfigurationException
    {
        ...
        ReplicaList order = full(host1, host2, host3);
        assertEquals(order, dsnitch.getSortedListByProximity(self, full(host1, host2, host3)));
        ...
        assertEquals(order, dsnitch.getSortedListByProximity(self, full(host1, host2, host3, host4)));
