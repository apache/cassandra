...
public class AuditLoggerTest extends CQLTester
{
    ...
    */
    ...
    public void testCqlFunctionAuditing() throws Throwable
    {
        ...
        String cql = "CREATE FUNCTION IF NOT EXISTS  " + KEYSPACE + "." + tblName + " (value TEXT,num int) RETURNS NULL ON NULL INPUT RETURNS text LANGUAGE java AS $$ return value.substring(0,num); $$";
