...
public class SSTablesSystemViewTest extends SAITester
{
    ...
    private int[] currentIdsSorted()
    {
        return getCurrentColumnFamilyStore().getLiveSSTables().stream().mapToInt(s -> s.descriptor.generation).sorted().toArray();
    }
