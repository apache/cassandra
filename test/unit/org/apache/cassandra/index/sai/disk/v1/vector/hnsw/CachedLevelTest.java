...
public class CachedLevelTest {
    private OnDiskHnswGraph.CachedLevel cachedLevelWithNeighbors;
    private OnDiskHnswGraph.CachedLevel cachedLevelWithOffsets;
    ...
    public void setup() {
        ...
        cachedLevelWithNeighbors = new OnDiskHnswGraph.CachedLevel(1, nodeIds, neighbors);
        cachedLevelWithOffsets = new OnDiskHnswGraph.CachedLevel(1, nodeIds, offsets);
    }
