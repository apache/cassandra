...
public class BKDTempFilesDirectory extends Directory
{
    ...
    public IndexOutput createTempOutput(String prefix, String suffix, IOContext context)
    {
        ...
        final File file = new File(delegate.descriptor.tmpFilenameFor(new Component(Component.Type.CUSTOM,
                                                                     "SAI" + "+" + Version.LATEST + "+" + index + "+" + name + ".db")));
    ...
    public IndexInput openInput(String name, IOContext context)
    {
        ...
        try (FileHandle.Builder builder = new FileHandle.Builder(indexInput.absolutePath()))
        {
