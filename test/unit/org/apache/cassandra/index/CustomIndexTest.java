...
public class CustomIndexTest extends CQLTester
{
    ...
    @Test
    public void indexerFailureDoesNotBlockDroppingFullyExpiredSSTables() throws Throwable
    {
    ...
    @Test
    public void notifyIndexesOfStaticRowsInFullyExpiredSSTablesDuringCompaction() throws Throwable
    {
    ...
    private static void awaitFullyExpired(ColumnFamilyStore cfs)
    {
        ...
        Util.spinAssertEquals("Timed out waiting for the SSTables to become fully expired",
                              true,
                              () -> FBUtilities.nowInSeconds() > maxLocalDeletionTime,
                              30, TimeUnit.SECONDS);
    }
