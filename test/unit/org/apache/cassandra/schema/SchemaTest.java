...
public class SchemaTest
{
    ...
    public void tablesInNewKeyspaceHaveCorrectEpoch()
    {
        ...
        applyAndAssertTableMetadata((metadata, isReplay) -> metadata.schema.getKeyspaces().withAddedOrUpdated(ksm), true);
    }
    ...
    public void newTablesInExistingKeyspaceHaveCorrectEpoch()
    {
        ...
        applyAndAssertTableMetadata((metadata, isReplay) -> metadata.schema.getKeyspaces().withAddedOrUpdated(updated), true);
    }
    ...
    public void newTablesInNonEmptyKeyspaceHaveCorrectEpoch()
    {
        ...
        applyAndAssertTableMetadata((metadata, isReplay) -> metadata.schema.getKeyspaces().withAddedOrUpdated(updated));
    }
    ...
    public void createTablesInMultipleKeyspaces()
    {
        ...
        Schema.instance.submit((metadata, isReplay) -> metadata.schema.getKeyspaces().withAddedOrUpdated(ksm1).withAddedOrUpdated(ksm2));
        ...
        applyAndAssertTableMetadata((metadata, isReplay) -> metadata.schema.getKeyspaces()
    ...
    public void createTablesInMultipleNonEmptyKeyspaces()
    {
        ...
        KeyspaceMetadata updated2 = ksm2.withSwapped(tables2);
        Schema.instance.submit((metadata, isReplay) -> metadata.schema.getKeyspaces().withAddedOrUpdated(updated1).withAddedOrUpdated(updated2));
