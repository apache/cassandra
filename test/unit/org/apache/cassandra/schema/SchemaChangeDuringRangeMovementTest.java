...
public class SchemaChangeDuringRangeMovementTest extends CQLTester
{
    ...
    public void testRestrictedChanges() throws Throwable
    {
        ...
        SchemaTransformation dropAllowed = (metadata_, isReplay) -> metadata_.schema.getKeyspaces().without(RF9_KS4).without(RF9_KS3);
        ...
        try
        {
            SchemaTransformation dropRejected = (metadata_, isReplay) -> metadata_.schema.getKeyspaces().without(RF9_KS2).without(RF9_KS1);
