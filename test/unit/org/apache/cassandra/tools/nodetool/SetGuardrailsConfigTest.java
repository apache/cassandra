...
public class SetGuardrailsConfigTest extends CQLTester
{
    ...
    public void testListAllSetters()
    {
        ...
        assertThat(tool.getStdout()).isEqualTo("setAllowFilteringEnabled\tboolean\n" +
                                               ...
                                               "setGuardrailsOnSuperuserEnabled\tboolean\n" +
    ...
    @Test
    public void testSetWithBooleanParams()
    {
        assertThat(mbean.getDDLEnabled()).isEqualTo(true);
        ToolRunner.ToolResult tool = ToolRunner.invokeNodetool("setguardrailsconfig", "setDDLEnabled", "false");
        tool.assertOnCleanExit();
        // check if the config is changed
        assertThat(mbean.getDDLEnabled()).isEqualTo(false);
        // reset
        tool = ToolRunner.invokeNodetool("setguardrailsconfig", "setDDLEnabled", "true");
        tool.assertOnCleanExit();
        assertThat(mbean.getDDLEnabled()).isEqualTo(true);
    }
}
