...
public class SetRoleManagerTest extends CQLTester
{
    @BeforeClass
    ...
    @Test
    public void testSetRoleManagerNull()
    {
        ToolRunner.ToolResult tool = ToolRunner.invokeNodetool("setrolemanager", "");
        assertThat(tool.getExitCode()).isEqualTo(1);
        assertThat(tool.getStdout().contains("Required parameters are missing"));
    }

    @Test
    public void testSetWrongRoleManager()
    {
        ToolRunner.ToolResult tool = ToolRunner.invokeNodetool("setrolemanager", "xyz");
        assertThat(tool.getExitCode()).isEqualTo(2);
        assertThat(tool.getCleanedStderr()).isNotEmpty();
    }

    @Test
    public void testSetRoleManager()
    {
        String roleManager = "org.apache.cassandra.auth.CassandraRoleManager";
        ToolRunner.ToolResult tool = ToolRunner.invokeNodetool("setrolemanager", roleManager);
