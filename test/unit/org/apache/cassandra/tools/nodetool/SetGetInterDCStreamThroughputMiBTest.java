...
/**
 * Tests for {@code nodetool setinterdcstreamthroughput} when set/get in mebibytes/s and {@code nodetool getinterdcstreamthroughput}.
 */
public class SetGetInterDCStreamThroughputMiBTest extends CQLTester
{
    @BeforeClass
    ...
    {
        ToolResult tool = invokeNodetool("setinterdcstreamthroughput", "-i", String.valueOf(throughput));
    ...
    {
        ToolResult tool = throughput == null ? invokeNodetool("setinterdcstreamthroughput", "-i")
                                             : invokeNodetool("setinterdcstreamthroughput", "-i", throughput);
    ...
    {
        ToolResult tool = throughput == null ? invokeNodetool("setinterdcstreamthroughput", "-i", "-e")
                                             : invokeNodetool("setinterdcstreamthroughput", "-i", throughput, "-e", throughput);
    ...
    {
        ToolResult tool = invokeNodetool("getinterdcstreamthroughput", "-i");
        tool.assertOnCleanExit();
