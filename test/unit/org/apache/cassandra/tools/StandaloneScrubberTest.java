...
public class StandaloneScrubberTest extends OfflineToolUtils
{
    ...
    {
        try (ToolRunner tool = runner.invokeClassAsTool(StandaloneScrubber.class.getName()))
        {
    ...
    public void testMaybeChangeDocs()
    {
        ...
        try (ToolRunner tool = runner.invokeClassAsTool(StandaloneScrubber.class.getName(), "-h"))
        {
    ...
    {
        try (ToolRunner tool = runner.invokeClassAsTool(StandaloneScrubber.class.getName(), "--debugwrong", "system_schema", "tables"))
        {
            assertThat(tool.getStdout(), CoreMatchers.containsStringIgnoringCase("usage:"));
    ...
    {
        try (ToolRunner tool = runner.invokeClassAsTool(StandaloneScrubber.class.getName(), "system_schema", "tables"))
        {
    ...
    public void testHelpArg()
    {
        Arrays.asList("-h", "--help").forEach(arg -> {
            try (ToolRunner tool = runner.invokeClassAsTool(StandaloneScrubber.class.getName(), arg))
            {
