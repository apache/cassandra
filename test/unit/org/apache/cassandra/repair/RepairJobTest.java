...
public class RepairJobTest
{
    ...
    private static class MeasureableRepairSession extends RepairSession
    {
        ...
        public MeasureableRepairSession(TimeUUID parentRepairSession, CommonRange commonRange, boolean excludedDeadNodes, String keyspace,
                                        ...
                                        boolean dontPurgeTombstones, boolean accordRepair, String... cfnames)
        {
            super(SharedContext.Global.instance, new Scheduler.NoopScheduler(),
                  ...
                  previewKind, optimiseStreams, repairPaxos, paxosOnly, dontPurgeTombstones, accordRepair, cfnames);
        }
    ...
    public void setup()
    {
        ...
        this.session = new MeasureableRepairSession(parentRepairSession,
                                                    ...
                                                    NONE, false, true, false, false, false, CF);
