...
public class RepairJobTest
{
    ...
    private static class MeasureableRepairSession extends RepairSession
    {
        ...
        {
            super(parentRepairSession, commonRange, excludedDeadNodes, keyspace, parallelismDegree, isIncremental, pullRepair,
    ...
    public void testNoTreesRetainedAfterDifference() throws Throwable
    {
        ...
        List<SyncTask> syncTasks = CassandraRepairJob.createStandardSyncTasks(sessionJobDesc, mockTreeResponses,
                                                                             addr4, // local
                                                                             noTransient(),
    ...
    public static void testCreateStandardSyncTasks(boolean pullRepair)
    {
        ...
        Map<SyncNodePair, SyncTask> tasks = toMap(CassandraRepairJob.createStandardSyncTasks(JOB_DESC,
                                                                                            treeResponses,
                                                                                            addr1, // local
    ...
    public void testOptimisedCreateStandardSyncTasksAllDifferent()
    {
        ...
        Map<SyncNodePair, SyncTask> tasks = toMap(CassandraRepairJob.createOptimisedSyncingSyncTasks(JOB_DESC,
                                                                                                    treeResponses,
                                                                                                    addr1, // local
                                                                                                    noTransient(),
                                                                                            addr -> "DC1",
    ...
    public void testOptimisedCreateStandardSyncTasksWithTransient()
    {
        ...
        Map<SyncNodePair, SyncTask> tasks = toMap(CassandraRepairJob.createOptimisedSyncingSyncTasks(desc,
                                                                                                    treeResponses,
                                                                                                    addr1, // local
                                                                                            ep -> ep.equals(addr3),
                                                                                            addr -> "DC1",
