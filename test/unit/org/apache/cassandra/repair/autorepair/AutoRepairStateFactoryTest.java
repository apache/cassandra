...
public class AutoRepairStateFactoryTest
{
    ...
    public void testGetRepairState()
    {
        ...
        state = RepairType.getAutoRepairState(RepairType.PAXOS_CLEANUP);

        assertTrue(state instanceof PaxosCleanupState);

        state = RepairType.getAutoRepairState(RepairType.BOOTSTRAP);

        assertTrue(state instanceof BootstrapRepairState);
    }
