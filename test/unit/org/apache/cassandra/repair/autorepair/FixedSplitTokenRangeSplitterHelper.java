...
public class FixedSplitTokenRangeSplitterHelper extends CQLTester
{
    ...
    public static void testTokenRangesSplitByTable(int numTokens, int numberOfSubRanges, AutoRepairConfig.RepairType repairType)
    {
        ...
        Collection<Range<Token>> tokens = StorageService.instance.getPrimaryRangesForEndpoint(KEYSPACE, FBUtilities.getBroadcastAddressAndPort());
        ...
        List<PrioritizedRepairPlan> plan = PrioritizedRepairPlan.buildSingleKeyspacePlan(FBUtilities.getBroadcastAddressAndPort(), repairType, KEYSPACE, TABLE1, TABLE2, TABLE3);
    ...
    public static void testTokenRangesWithDefaultSplit(int numTokens, AutoRepairConfig.RepairType repairType)
    {
        ...
        List<PrioritizedRepairPlan> plan = PrioritizedRepairPlan.buildSingleKeyspacePlan(FBUtilities.getBroadcastAddressAndPort(), repairType, KEYSPACE, TABLE1);
