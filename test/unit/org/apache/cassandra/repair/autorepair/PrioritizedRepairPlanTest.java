...
public class PrioritizedRepairPlanTest extends CQLTester
{
    ...
    public void testBuildWithDifferentPriorities()
    {
        ...
        List<PrioritizedRepairPlan> prioritizedRepairPlans = PrioritizedRepairPlan.buildSingleKeyspacePlan(FBUtilities.getBroadcastAddressAndPort(), AutoRepairConfig.RepairType.FULL, KEYSPACE, table1, table2, table3);
    ...
    public void testBuildWithMixedPriorities()
    {
        ...
        // Expect 4 plans
        List<PrioritizedRepairPlan> prioritizedRepairPlans = PrioritizedRepairPlan.build(FBUtilities.getBroadcastAddressAndPort(), keyspaceToTableMap, AutoRepairConfig.RepairType.FULL, java.util.Collections::sort);
    ...
    public void testBuildWithEmptyTableList()
    {
        ...
        List<PrioritizedRepairPlan> prioritizedRepairPlans = PrioritizedRepairPlan.buildSingleKeyspacePlan(FBUtilities.getBroadcastAddressAndPort(), AutoRepairConfig.RepairType.FULL, KEYSPACE);
    ...
    public void testBuildWithOneTable()
    {
        ...
        // Expect only 1 plans
        List<PrioritizedRepairPlan> prioritizedRepairPlans = PrioritizedRepairPlan.buildSingleKeyspacePlan(FBUtilities.getBroadcastAddressAndPort(), AutoRepairConfig.RepairType.FULL, KEYSPACE, table1);
        assertEquals(1, prioritizedRepairPlans.size());
