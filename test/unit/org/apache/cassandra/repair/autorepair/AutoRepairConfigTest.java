...
public class AutoRepairConfigTest extends CQLTester
{
    ...
    public void testGetDefaultOptionsMVRepairIsEnabledByDefault()
    {
        ...
        assertTrue(defaultOptions.materialized_view_repair_enabled);
    }
    ...
    public void testSetAbortAutoRepairAfter()
    {
        ...
        assertEquals(300, config.getOptions(repairType).abort_auto_repair_after.toSeconds());
    }
    ...
    public void testDefaultOptions()
    {
        ...
        assertTrue(options.materialized_view_repair_enabled);
    ...
    public void testGlobalOptions()
    {
        ...
        assertTrue(config.global_settings.materialized_view_repair_enabled);
