...
public class AutoRepairParameterizedTest extends CQLTester
{
    ...
    public void setup()
    {
        ...
        Keyspace.open(SchemaConstants.AUTO_REPAIR_KEYSPACE_NAME).getColumnFamilyStore(AutoRepairKeyspace.AUTO_REPAIR_HISTORY).truncateBlocking();
    ...
    {
        assertTrue(TableAttributes.validKeywords().contains("disabled_automated_repair"));
    }

    @Test
    public void testDefaultAutomatedRepairEnablement()
    {
        assertFalse(cfm.params.disableAutomatedRepair);
    }
}
