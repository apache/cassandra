...
public class RepairTokenRangeSplitterTest extends CQLTester
{
    ...
    public void testTokenRangesRepairByKeyspace()
    {
        ...
        final KeyspaceRepairPlan repairPlan = new KeyspaceRepairPlan(FBUtilities.getBroadcastAddressAndPort(), "system_auth", new ArrayList<>(TABLE_NAMES));
        ...
        {
            assertEquals(TABLE_NAMES.size(), assignment.getTableNames().size());
        }
    }
    ...
    public void testTokenRangesRepairByKeyspaceFalse()
    {
        ...
        assertEquals(2 * TABLE_NAMES.size(), assignments.size());
