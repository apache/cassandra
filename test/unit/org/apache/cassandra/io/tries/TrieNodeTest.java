...
public class TrieNodeTest
{
    ...
    public void testTypeFor0Children()
    {
        ...
        assertSame(TrieNode.PayloadOnly.PAYLOAD_ONLY, TrieNode.typeFor(sn, 0));
    }
    ...
    public void testTypeFor1ChildNoPayload()
    {
        ...
        qt().forAll(Generate.pick(Arrays.asList(
                Pair.of(Ranges.BITS_4, TrieNode.SingleNoPayload4.SINGLE_NOPAYLOAD_4),
                Pair.of(Ranges.BITS_8, TrieNode.Single.SINGLE_8),
                Pair.of(Ranges.BITS_12, TrieNode.SingleNoPayload12.SINGLE_NOPAYLOAD_12),
                Pair.of(Ranges.BITS_16, TrieNode.Single.SINGLE_16),
                Pair.of(Ranges.BITS_24, TrieNode.Dense.DENSE_24),
                Pair.of(Ranges.BITS_32, TrieNode.Dense.DENSE_32),
                Pair.of(Ranges.BITS_40, TrieNode.Dense.DENSE_40),
                Pair.of(Ranges.BITS_GT40, TrieNode.LongDense.LONG_DENSE)
    ...
    public void testTypeFor1ChildAndPayload()
    {
        ...
        qt().forAll(Generate.pick(Arrays.asList(
                Pair.of(Ranges.BITS_4, TrieNode.Single.SINGLE_8),
                Pair.of(Ranges.BITS_8, TrieNode.Single.SINGLE_8),
                Pair.of(Ranges.BITS_12, TrieNode.Single.SINGLE_16),
                Pair.of(Ranges.BITS_16, TrieNode.Single.SINGLE_16),
                Pair.of(Ranges.BITS_24, TrieNode.Dense.DENSE_24),
                Pair.of(Ranges.BITS_32, TrieNode.Dense.DENSE_32),
                Pair.of(Ranges.BITS_40, TrieNode.Dense.DENSE_40),
    ...
    public void testTypeForMoreChildrenAndNoPayload()
    {
        ...
        qt().forAll(Generate.pick(Arrays.asList(
                Pair.of(Ranges.BITS_4, TrieNode.Dense12.DENSE_12),
                Pair.of(Ranges.BITS_8, TrieNode.Dense12.DENSE_12),
                Pair.of(Ranges.BITS_12, TrieNode.Dense12.DENSE_12),
                Pair.of(Ranges.BITS_16, TrieNode.Dense.DENSE_16),
                Pair.of(Ranges.BITS_24, TrieNode.Dense.DENSE_24),
                Pair.of(Ranges.BITS_32, TrieNode.Dense.DENSE_32),
                Pair.of(Ranges.BITS_40, TrieNode.Dense.DENSE_40),
                Pair.of(Ranges.BITS_GT40, TrieNode.LongDense.LONG_DENSE)
    ...
    {
        TrieNode.PayloadOnly.PAYLOAD_ONLY.serialize(out, null, 1 | 4, 0);
        out.flush();

        TrieNode node = TrieNode.at(out.asNewBuffer(), 0);
        assertEquals(TrieNode.PayloadOnly.PAYLOAD_ONLY, node);
    ...
    public void testSingle16Node() throws IOException
    {
        ...
        TrieNode.Single.SINGLE_16.serialize(out, sn, 1 | 4, 0);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 0);
        assertEquals(TrieNode.Single.SINGLE_16, node);
    ...
    public void testSingleNoPayload4Node() throws IOException
    {
        ...
        TrieNode.SingleNoPayload4.SINGLE_NOPAYLOAD_4.serialize(out, sn, 0, 0);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 0);
        assertEquals(TrieNode.SingleNoPayload4.SINGLE_NOPAYLOAD_4, node);
    ...
    public void testSingleNoPayload12Node() throws IOException
    {
        ...
        TrieNode.SingleNoPayload12.SINGLE_NOPAYLOAD_12.serialize(out, sn, 0, 0);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 0);
        assertEquals(TrieNode.SingleNoPayload12.SINGLE_NOPAYLOAD_12, node);
    ...
    public void testSparse16Node() throws IOException
    {
        ...
        TrieNode.Sparse.SPARSE_16.serialize(out, sn, 1 | 4, 6);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 6);
        assertEquals(TrieNode.Sparse.SPARSE_16, node);
    ...
    public void testSparse12Node() throws IOException
    {
        ...
        TrieNode.Sparse12.SPARSE_12.serialize(out, sn, 1 | 4, 6);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 6);
        assertEquals(TrieNode.Sparse12.SPARSE_12, node);
    ...
    public void testDense16Node() throws IOException
    {
        ...
        TrieNode.Dense.DENSE_16.serialize(out, sn, 1 | 4, 6);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 6);
        assertEquals(TrieNode.Dense.DENSE_16, node);
    ...
    public void testDense12Node() throws IOException
    {
        ...
        TrieNode.Dense12.DENSE_12.serialize(out, sn, 1 | 4, 6);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 6);
        assertEquals(TrieNode.Dense12.DENSE_12, node);
    ...
    public void testLongDenseNode() throws IOException
    {
        ...
        TrieNode.LongDense.LONG_DENSE.serialize(out, sn, 1 | 4, 6);
        TrieNode node = TrieNode.at(out.asNewBuffer(), 6);
        assertEquals(TrieNode.LongDense.LONG_DENSE, node);
