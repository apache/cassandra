...
public class LargePartitionsTest extends CQLTester
{
    ...
    private void withPartitionSize(long partitionKibibytes, long totalMebibytes) throws Throwable
    {
        long totalKibibytes = totalMebibytes * 1024L;

        createTable("CREATE TABLE %s (pk text, ck text, val text, PRIMARY KEY (pk, ck))");

        String name = "part=" + partitionKibibytes + "k total=" + totalMebibytes + 'M';
