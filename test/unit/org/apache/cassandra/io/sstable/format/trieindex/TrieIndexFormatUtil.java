...
public class TrieIndexFormatUtil
{
                                            ...
                                            FileHandle dfile)
    {
        ...
        return new BtiTableReaderBuilder(desc).setComponents(components)
                                              .setTableMetadataRef(metadata)
                                              .setSerializationHeader(header)
                                              .setStatsMetadata(sstableMetadata)
                                              .setPartitionIndex(partitionIndex.sharedCopy())
                                              .setFilter(FilterFactory.AlwaysPresent)
                                              .setOpenReason(OpenReason.NORMAL)
                                              .setMaxDataAge(1)
                                              .setRowIndexFile(ifile)
                                              .setDataFile(dfile)
