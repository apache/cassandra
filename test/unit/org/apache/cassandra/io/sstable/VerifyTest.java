...
public class VerifyTest
{
    ...
    public void testVerifyMutateRepairStatus() throws IOException, WriteTimeoutException
    {
        ...
        SSTableReader sstable = cfs.getLiveSSTables().iterator().next();
        sstable.descriptor.getMetadataSerializer().mutateRepairMetadata(sstable.descriptor, System.currentTimeMillis(), sstable.getPendingRepair(), sstable.isWitness());
    ...
    public void testMutateRepair() throws IOException
    {
        ...
        SSTableReader sstable = cfs.getLiveSSTables().iterator().next();
        sstable.descriptor.getMetadataSerializer().mutateRepairMetadata(sstable.descriptor, 1, sstable.getPendingRepair(), sstable.isWitness());
        sstable.reloadSSTableMetadata();
