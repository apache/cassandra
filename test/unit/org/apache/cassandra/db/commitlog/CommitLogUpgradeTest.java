...
public class CommitLogUpgradeTest
{
    ...
    {
        testKiller = new TestKiller();
        originalKiller = JVMStabilityInspector.replaceKiller(testKiller);
    }
    ...
    public void cleanUp()
    {
        ...
        Assert.assertEquals("JVM killed", shouldBeKilled, testKiller.wasKilled());
    }
