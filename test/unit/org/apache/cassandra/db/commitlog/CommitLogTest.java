...
public abstract class CommitLogTest
{
    ...
    private static KillerForTesting killerForTesting;
    ...
    public static void beforeClass() throws ConfigurationException
    {
        ...
        oldKiller = JVMStabilityInspector.replaceKiller(killerForTesting);
    }
    ...
    protected void runExpecting(Callable<Void> r, Class<?> expected)
    {
        ...
        assertEquals("JVM kill state doesn't match expectation.", expected != null, killerForTesting.wasKilled());
    }
