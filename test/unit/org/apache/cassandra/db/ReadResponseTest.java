...
public class ReadResponseTest
{
    ...
    public void fromCommandWithConclusiveRepairedDigest()
    {
        ...
        ReadResponse response = ReadResponse.fromResponse(command.createResponse(EmptyIterators.unfilteredPartition(metadata), rdi));
    ...
    public void makeDigestDoesntConsiderRepairedDataInfo()
    {
        ...
        ReadResponse response1 = ReadResponse.fromResponse(command1.createResponse(EmptyIterators.unfilteredPartition(metadata), rdi1));
        ...
        ReadResponse response2 = ReadResponse.fromResponse(command1.createResponse(EmptyIterators.unfilteredPartition(metadata), rdi2));
