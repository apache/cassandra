...
public class AccordDebugKeyspaceTest extends CQLTester
{
    ...
    private void testPatchJournal(String cleanupAction, String expectedStatus)
    {
        ...
        try
        {
            ...
            String PATCH_JOURNAL = String.format("UPDATE %s.%s SET cleanup = ? WHERE txn_id=? AND command_store_id = ?", SchemaConstants.VIRTUAL_ACCORD_DEBUG, AccordDebugKeyspace.COMMAND_STORE);
