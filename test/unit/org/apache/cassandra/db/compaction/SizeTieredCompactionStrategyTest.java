...
public class SizeTieredCompactionStrategyTest
{
    ...
    public void testMinSSTableSizeUnits() throws ConfigurationException
    {
        ...
        assertEquals(50L * 1024 * 1024, new SizeTieredCompactionStrategyOptions(options).minSSTableSize);
        assertEquals(50L * 1024 * 1024, new SizeTieredCompactionStrategyOptions().minSSTableSize);
