...
public class CompactionStrategyManagerBoundaryReloadTest extends CQLTester
{
    ...
    public void testReload() throws UnknownHostException
    {
        ...
        long tk1 = 2;
        long tk2 = 1;
        tmd.updateNormalToken(new LongToken(tk1), InetAddressAndPort.getByName("127.0.0.1"));
        tmd.updateNormalToken(new LongToken(tk2), InetAddressAndPort.getByName("127.0.0.2"));
