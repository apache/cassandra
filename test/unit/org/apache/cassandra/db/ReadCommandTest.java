...
public class ReadCommandTest
{
    ...
    private static void runPartitionReadCommands(ColumnFamilyStore cfs, Set<String> partitionKeys) throws IOException
    {
        ...
        int nowInSeconds = FBUtilities.nowInSeconds(); // all reads within a group must have the same nowInSec
    ...
    private static final int NEW_DELETION = FBUtilities.nowInSeconds();
    private static final int PURGEABLE_DELETION = 42;
    ...
    private static class TestWriteOperation
    {
        ...
        public TestWriteOperation(OperationType type, String partitionKey,
                                  ...
                                  String columnName, int deletionTime)
        {
            this.type = type;
        ...
        public static TestWriteOperation deletePartition(String partitionKey, int deletionTime)
        {
            return new TestWriteOperation(OperationType.DELETE_PARTITION, partitionKey,
                                          null, null, null, null, deletionTime);
        }

        public static TestWriteOperation deleteRange(String partitionKey, String clusteringRangeStart, String clusteringRangeEnd, int deletionTime)
        {
        ...
        public static TestWriteOperation deleteRow(String partitionKey, String clusteringKey, int deletionTime)
        {
            return new TestWriteOperation(OperationType.DELETE_ROW, partitionKey, clusteringKey,
                                          null, null, null, deletionTime);
        }

        public static TestWriteOperation deleteCell(String partitionKey, String clusteringKey, String columnName, int deletionTime)
        {
    ...
    private static SinglePartitionReadCommand getWholePartitionReadCommand(ColumnFamilyStore cfs, String partitionKey, int nowInSeconds)
    {
        ColumnFilter columnFilter = ColumnFilter.allRegularColumnsBuilder(cfs.metadata(), false).build();
        RowFilter rowFilter = RowFilter.create();
        Slice slice = Slice.make(BufferClusteringBound.BOTTOM, BufferClusteringBound.TOP);
