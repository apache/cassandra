...
public class MutationTrackingMigrationRepairResultTest
{
    ...
    public void testGlobalIncrementalDataRepairEligible()
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, true, true, false, true);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, true, false, true, true, false, true);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, true, true, true, false, true);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, false, true, false, true);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    {
        MutationTrackingMigrationRepairResult result =
            MutationTrackingMigrationRepairResult.fromRepair(TEST_EPOCH, false, false, true, false, false, true);
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
    ...
    public void testPullRepairIneligible()
    {
        ...
        assertFalse(result.eligible);
        assertEquals(Epoch.EMPTY, result.minEpoch);
        assertTrue(result.ineligibleReason.contains("pull repair"));
    }
