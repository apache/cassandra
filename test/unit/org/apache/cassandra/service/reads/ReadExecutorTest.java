...
public class ReadExecutorTest
{
    ...
    public static class MockSinglePartitionReadCommand extends SinglePartitionReadCommand
    {
        ...
        {
            super(cfs.metadata().epoch, false, 0, PotentialTxnConflicts.DISALLOW, cfs.metadata(), 0, null, null, null, Util.dk("ry@n_luvs_teh_y@nk33z"), null, null, false, null);
    ...
    {
        return CoordinationPlanTestUtils.create(new ReplicaPlan.ForTokenRead(ks, ks.getReplicationStrategy(), consistencyLevel, natural, selected, natural, (cm) -> null, (self) -> null, Epoch.EMPTY));
    }
}
