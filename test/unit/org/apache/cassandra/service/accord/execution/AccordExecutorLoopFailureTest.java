 ...
 * {@code Invariants.require(owner != self)} failure in {@link SignalLock#awaitAsyncOrLock} one iteration after the
 * fault:
 * <ul>
 *   <li>a nested acquisition inside exclusive work that is never released (the shape of {@code ExclusiveCaches.close()}
 *       skipping its unlock): the unwind popped only one level of the reentrant hold;</li>
 ...
 *       kill): the throw escaped the loop's catch and silently killed the loop thread.</li>
 * </ul>
 *
