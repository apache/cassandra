...
import org.apache.cassandra.config.SSTableCompressionOptions.CompressorType;
...
public class SSTableCompressonOptionsTest
{
    ...
    public void defaultTest()
    {
        ...
        assertParams(true, DEFAULT_CHUNK_LENGTH, LZ4Compressor.class);
    }

    @Test
    public void lz4Test()
    {
        options.type = CompressorType.lz4;
        params = options.getCompressionParams();
        assertParams(true, DEFAULT_CHUNK_LENGTH, LZ4Compressor.class);
        ...
        assertEquals("0.5", map.get(MIN_COMPRESS_RATIO));

        options.enabled = false;
        params = options.getCompressionParams();
        assertParams(false, DEFAULT_CHUNK_LENGTH, null);
    }

    @Test
    public void noneTest()
    {
        options.type = CompressorType.none;
        params = options.getCompressionParams();
        ...
        assertParams(false, DEFAULT_CHUNK_LENGTH, null);
        Map<String, String> map = params.asMap();
        assertNull(map.get(MIN_COMPRESS_RATIO));
    ...
    {
        options.type = CompressorType.noop;
        params = options.getCompressionParams();
        assertParams(true, DEFAULT_CHUNK_LENGTH, NoopCompressor.class);
    ...
    {
        options.type = CompressorType.snappy;
        params = options.getCompressionParams();
        assertParams(true, DEFAULT_CHUNK_LENGTH, SnappyCompressor.class);
    ...
    {
        options.type = CompressorType.deflate;
        params = options.getCompressionParams();
        assertParams(true, DEFAULT_CHUNK_LENGTH, DeflateCompressor.class);
    ...
    {
        options.type = CompressorType.zstd;
        params = options.getCompressionParams();
        assertParams(true, DEFAULT_CHUNK_LENGTH, ZstdCompressor.class);
    ...
    {
        options.type = CompressorType.custom;
        options.compressor = new ParameterizedClass(TestCompressor.class.getName(), Collections.emptyMap());
        params = options.getCompressionParams();
        assertParams(true, DEFAULT_CHUNK_LENGTH, TestCompressor.class);
