...
public class FunctionalTransformRequest implements org.apache.thrift.TBase<FunctionalTransformRequest, FunctionalTransformRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FunctionalTransformRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FunctionalTransformRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new FunctionalTransformRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FunctionalTransformRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FunctionalTransformRequest.class, metaDataMap);
  }

  public FunctionalTransformRequest() {
   ...
   */
  public FunctionalTransformRequest(FunctionalTransformRequest other) {
    if (other.isSetKey()) {
...
;
  ...
  public FunctionalTransformRequest deepCopy() {
    return new FunctionalTransformRequest(this);
  }
  ...
  public FunctionalTransformRequest setKey(byte[] key) {
    setKey(key == null ? (ByteBuffer)null : ByteBuffer.wrap(key));
    return this;
  }

  public FunctionalTransformRequest setKey(ByteBuffer key) {
    this.key = key;
    return this;
  }
  ...
  public FunctionalTransformRequest setColumn_family(String column_family) {
  ...
  public FunctionalTransformRequest setFunction_name(String function_name) {
  ...
  public FunctionalTransformRequest setFunction_properties(Map<ByteBuffer,ByteBuffer> function_properties) {
   ...
   * @see org.apache.cassandra.thrift.ConsistencyLevel
   */
  public FunctionalTransformRequest setSerial_consistency_level(org.apache.cassandra.thrift.ConsistencyLevel serial_consistency_level) {
   ...
   * @see org.apache.cassandra.thrift.ConsistencyLevel
   */
  public FunctionalTransformRequest setCommit_consistency_level(org.apache.cassandra.thrift.ConsistencyLevel commit_consistency_level) {
  ...
  public FunctionalTransformRequest setPredicate(org.apache.cassandra.thrift.SlicePredicate predicate) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FunctionalTransformRequest)
      return this.equals((FunctionalTransformRequest)that);
    return false;
  }

  public boolean equals(FunctionalTransformRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FunctionalTransformRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FunctionalTransformRequest(");
    boolean first = true;
  ...
  private static class FunctionalTransformRequestStandardSchemeFactory implements SchemeFactory {
    public FunctionalTransformRequestStandardScheme getScheme() {
      return new FunctionalTransformRequestStandardScheme();
    }
  }

  private static class FunctionalTransformRequestStandardScheme extends StandardScheme<FunctionalTransformRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FunctionalTransformRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FunctionalTransformRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FunctionalTransformRequestTupleSchemeFactory implements SchemeFactory {
    public FunctionalTransformRequestTupleScheme getScheme() {
      return new FunctionalTransformRequestTupleScheme();
    }
  }

  private static class FunctionalTransformRequestTupleScheme extends TupleScheme<FunctionalTransformRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FunctionalTransformRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FunctionalTransformRequest struct) throws org.apache.thrift.TException {
