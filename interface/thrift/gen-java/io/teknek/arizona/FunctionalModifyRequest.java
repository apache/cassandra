...
public class FunctionalModifyRequest implements org.apache.thrift.TBase<FunctionalModifyRequest, FunctionalModifyRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FunctionalModifyRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FunctionalModifyRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new FunctionalModifyRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FunctionalModifyRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FunctionalModifyRequest.class, metaDataMap);
  }

  public FunctionalModifyRequest() {
   ...
   */
  public FunctionalModifyRequest(FunctionalModifyRequest other) {
    if (other.isSetKey()) {
...
;
  ...
  public FunctionalModifyRequest deepCopy() {
    return new FunctionalModifyRequest(this);
  }
  ...
  public FunctionalModifyRequest setKey(byte[] key) {
    setKey(key == null ? (ByteBuffer)null : ByteBuffer.wrap(key));
    return this;
  }

  public FunctionalModifyRequest setKey(ByteBuffer key) {
    this.key = key;
    return this;
  }
  ...
  public FunctionalModifyRequest setColumn_family(String column_family) {
  ...
  public FunctionalModifyRequest setFunction_name(String function_name) {
  ...
  public FunctionalModifyRequest setFunction_properties(Map<ByteBuffer,ByteBuffer> function_properties) {
   ...
   * @see org.apache.cassandra.thrift.ConsistencyLevel
   */
  public FunctionalModifyRequest setSerial_consistency_level(org.apache.cassandra.thrift.ConsistencyLevel serial_consistency_level) {
   ...
   * @see org.apache.cassandra.thrift.ConsistencyLevel
   */
  public FunctionalModifyRequest setCommit_consistency_level(org.apache.cassandra.thrift.ConsistencyLevel commit_consistency_level) {
  ...
  public FunctionalModifyRequest setPredicate(org.apache.cassandra.thrift.SlicePredicate predicate) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FunctionalModifyRequest)
      return this.equals((FunctionalModifyRequest)that);
    return false;
  }

  public boolean equals(FunctionalModifyRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FunctionalModifyRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FunctionalModifyRequest(");
    boolean first = true;
  ...
  private static class FunctionalModifyRequestStandardSchemeFactory implements SchemeFactory {
    public FunctionalModifyRequestStandardScheme getScheme() {
      return new FunctionalModifyRequestStandardScheme();
    }
  }

  private static class FunctionalModifyRequestStandardScheme extends StandardScheme<FunctionalModifyRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FunctionalModifyRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FunctionalModifyRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FunctionalModifyRequestTupleSchemeFactory implements SchemeFactory {
    public FunctionalModifyRequestTupleScheme getScheme() {
      return new FunctionalModifyRequestTupleScheme();
    }
  }

  private static class FunctionalModifyRequestTupleScheme extends TupleScheme<FunctionalModifyRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FunctionalModifyRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FunctionalModifyRequest struct) throws org.apache.thrift.TException {
