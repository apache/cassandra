...
def argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--repeat-stop-on-failure", action="store_true", help="Stop a *-repeat stage on the first failed run (default: run all iterations and report the failure rate)")
