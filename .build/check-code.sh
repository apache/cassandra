...
# append, as _docker_run.sh passes -Dbuild.dir=${DIST_DIR} in ANT_OPTS
ANT_OPTS="${ANT_OPTS} -Xmx2g -XX:+PrintClassHistogram -XX:OnOutOfMemoryError='kill -QUIT %p'"
export ANT_OPTS

# execute. the check target runs rat-check, checkstyle and checkstyle-test,
# and depends on _main-jar, build-test and gen-doc. see build.xml
