...
4.1.1. STARTUP
  ...
  The body is a [string map] of options. Possible options are:
    ...
    - "OVERLOADED_EXCEPTION_ENABLED": In case of server overloaded with too many requests, by default the server puts
...
10. Changes from v4
  ...
  * Added OVERLOADED_EXCEPTION_ENABLED startup option (Section 4.1.1).
