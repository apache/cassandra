...
<<<<<<< HEAD:doc/source/modules/cassandra/pages/configuration/cass_yaml_file.adoc
=======
...
``commitlog_directory``
-----------------------
>>>>>>> d7aaaa50013d1e275bc5836a48c64893e1365f43:doc/source/configuration/cass_yaml_file.rst
*This option is commented out by default.*
