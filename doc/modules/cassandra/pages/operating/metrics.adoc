...
|Latency |Histogram |Transaction read latency.
...
|Latency |Histogram |Transaction write latency.
...
|Latency |Histogram |Read latency.
|Unavailables |Counter |Number of unavailable exceptions encountered.
|===
...
|Latency |Histogram |Range query latency.
|Unavailables |Counter |Number of unavailable exceptions encountered.
|===
...
|Latency |Histogram |Write latency.
|Unavailables |Counter |Number of unavailable exceptions encountered.
|MutationSizeHistogram |Histogram |Total size in bytes of the requests
mutations.
|===
...
|Hints_not_stored-<PeerIP> | Counter | Number of hints not stored for this peer, due to being down past the
...
|Misses |Meter |The rate of misses in the pool. The higher this is the more allocations
incurred.
