...
See the xref:cassandra:developing/cql/functions.adoc#writetime-and-ttl-fucntions[functions] section for details.
...
Please refer to the xref:cassandra:developing/cql/dml.adoc#upsert-parameters[INSERT PARAMETERS] section for informations on the `insert_parameter`.
