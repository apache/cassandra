...
[NOTE]
====
Experimental support for Java 11 was added in Cassandra {40_version}
...
[NOTE]
====
A new Linux user `cassandra` will get created as part of the
...
xref:cassandra:troubleshooting/index.html[Troubleshooting]
section.
