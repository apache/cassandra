...
*Metric Name*::
`org.apache.cassandra.metrics.AutoRepairMetrics.<MetricName>`
*JMX MBean*::
`org.apache.cassandra.metrics:type=AutoRepairMetrics name=<MetricName>`
...
|FailedTablesCount |Gauge<Integer> |Number of tables encountered
failure during repair on the node
