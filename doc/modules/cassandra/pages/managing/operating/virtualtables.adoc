...
|compaction_operations_history | All compaction operations that are currently running or have been completed since the
node started. The default history size is 300, but can be changed by setting `cassandra.operations_history_size` system
property.
