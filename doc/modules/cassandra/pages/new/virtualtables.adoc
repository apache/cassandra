...
....
cqlsh> select address, port, generation, heartbeat, load, dc, rack, release_version from system_views.gossip_info;

 address   | port | generation | heartbeat | load    | dc          | rack  | release_version
-----------+------+------------+-----------+---------+-------------+-------+-----------------
 127.0.0.1 | 7000 | 1645575140 |       312 | 70542.0 | datacenter1 | rack1 |    4.1-SNAPSHOT
 127.0.0.2 | 7000 | 1645575135 |       318 | 70499.0 | datacenter1 | rack1 |    4.1-SNAPSHOT
 127.0.0.3 | 7000 | 1645575140 |       312 | 70504.0 | datacenter1 | rack1 |    4.1-SNAPSHOT
 127.0.0.4 | 7000 | 1645575141 |       311 | 70502.0 | datacenter1 | rack1 |    4.1-SNAPSHOT
 127.0.0.5 | 7000 | 1645575136 |       315 | 70500.0 | datacenter1 | rack1 |    4.1-SNAPSHOT
