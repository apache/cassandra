...
Currently, SAI uses https://github.com/jbellis/jvector[JVector], an algorithm for Approximate Nearest Neighbor (ANN) search and close cousin to xHierarchical Navigable Small World (HNSW).
