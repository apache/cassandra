 ...
 */
public class AlterPolicyStatement extends AbacStatement
{
    ...
    public AlterPolicyStatement(PolicyName policyName, CFName cfname, Set<Permission> perms, PolicyClause policyClause)
    {
        super(cfname);
    ...
    public void checkAccess(ClientState state) throws UnauthorizedException, InvalidRequestException
    {
        ...
        state.hasColumnFamilyAccess(keyspace(), cfName.getColumnFamily(), Permission.ALTER);
    }
