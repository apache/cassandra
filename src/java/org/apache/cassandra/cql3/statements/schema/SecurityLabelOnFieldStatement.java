 ...
 * </p>
 * <p>
 * Syntax: {@code SECURITY LABEL ON FIELD [keyspace_name.]type_name.field_name IS 'label';}
 * </p>
 * <p>
...
public final class SecurityLabelOnFieldStatement extends AlterSchemaStatement
{
    ...
    public SecurityLabelOnFieldStatement(String keyspaceName, String typeName, FieldIdentifier fieldName, String securityLabel, String provider)
    {
        super(keyspaceName);
    ...
    {
        return String.format("%s (%s.%s.%s, %s)", getClass().getSimpleName(), keyspaceName, typeName, fieldName, securityLabel);
    }
