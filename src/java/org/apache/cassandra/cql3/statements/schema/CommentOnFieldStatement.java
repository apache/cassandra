...
public final class CommentOnFieldStatement extends AlterSchemaStatement
{
    ...
    public CommentOnFieldStatement(String keyspaceName, String typeName, FieldIdentifier fieldName, String comment)
    {
        super(keyspaceName);
    ...
    public Keyspaces apply(ClusterMetadata metadata)
    {
        ...
        UserType newType = type.withFieldComment(fieldName, comment);
    ...
    {
        return String.format("%s (%s.%s.%s, %s)", getClass().getSimpleName(), keyspaceName, typeName, fieldName, comment);
    }
    ...
    public static final class Raw extends CQLStatement.Raw
    {
        ...
        @Override
        public CommentOnFieldStatement prepare(ClientState state)
        {
            String keyspaceName = typeName.hasKeyspace() ? typeName.getKeyspace() : state.getKeyspace();
            return new CommentOnFieldStatement(keyspaceName,
