 ...
 * </p>
 * <p>
 * Syntax: {@code SECURITY LABEL ON COLUMN [keyspace_name.]table_name.column_name IS 'label';}
 * </p>
 * <p>
...
public final class SecurityLabelOnColumnStatement extends AlterSchemaStatement
{
    ...
    {
        return String.format("%s (%s.%s.%s, %s)", getClass().getSimpleName(), keyspaceName, tableName, columnName, securityLabel);
    }
