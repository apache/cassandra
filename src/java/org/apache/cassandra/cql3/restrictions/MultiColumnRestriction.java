...
public abstract class MultiColumnRestriction implements SingleRestriction
{
    ...
    public static class EQRestriction extends MultiColumnRestriction
    {
        ...
        public EQRestriction(List<ColumnMetadata> columnDefs, Term term)
        {
            super(columnDefs);
            this.term = term;
        }
        ...
        {
            SliceRestriction start = SliceRestriction.fromBound(columnDefs, Bound.START, true, this.term);
            SliceRestriction end = SliceRestriction.fromBound(columnDefs, Bound.END, true, this.term);
    ...
    public static class INRestriction extends MultiColumnRestriction
    {
        ...
        public MultiClusteringBuilder appendTo(MultiClusteringBuilder builder, QueryOptions options)
        {
            List<List<ByteBuffer>> values = terms.bindAndGetTuples(options, columnIdentifiers);
                                         ...
                                         QueryOptions options)
        {
            ...
            {
                List<List<ByteBuffer>> splitValues = terms.bindAndGetTuples(options, columnIdentifiers);
                ...
                ByteBuffer buffer = CollectionSerializer.pack(values, values.size(), options.getProtocolVersion());
