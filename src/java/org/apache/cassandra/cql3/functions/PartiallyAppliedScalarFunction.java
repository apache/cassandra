 ...
 *
 * @see ScalarFunction#partialApplication(FunctionContext, List)
 */
final class PartiallyAppliedScalarFunction extends NativeScalarFunction implements PartialScalarFunction
{
    ...
    {
        return new PartialFunctionArguments(context, function, partialParameters, argTypes.size());
    }
    ...
    private static final class PartialFunctionArguments implements Arguments
    {
        ...
        public PartialFunctionArguments(FunctionContext context, ScalarFunction function, List<ByteBuffer> partialArguments, int unresolvedCount)
        {
