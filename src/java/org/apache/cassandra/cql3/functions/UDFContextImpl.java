...
public final class UDFContextImpl implements UDFContext
{
    ...
    /*
    We need to lazily get the metadata because when creating non-system tables with UDF the metadata we need
    when the UDFContextImpl is constructed is the one being constructed.
     */
