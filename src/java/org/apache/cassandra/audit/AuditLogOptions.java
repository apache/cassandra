...
public class AuditLogOptions extends BinLogOptions
{
    ...
    public static class Builder
    {
        ...
        {
            sanitise(includedCategories).map(v -> this.includedCategories = LocalizeString.toUpperCaseLocalized(v));
            return this;
        }

        public Builder withExcludedCategories(final String excludedCategories)
        {
            sanitise(excludedCategories).map(v -> this.excludedCategories = LocalizeString.toUpperCaseLocalized(v));
            return this;
        }
        ...
        {
            sanitise(rollCycle).map(v -> this.rollCycle = LocalizeString.toUpperCaseLocalized(v));
            return this;
        }
        ...
        public AuditLogOptions build()
        {
            ...
            sanitise(this.includedCategories).map(v -> opts.included_categories = LocalizeString.toUpperCaseLocalized(v));
            sanitise(this.excludedCategories).map(v -> opts.excluded_categories = LocalizeString.toUpperCaseLocalized(v));
