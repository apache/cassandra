...
public class TableId
{
    ...
    {
        assert SchemaConstants.isLocalSystemKeyspace(keyspace) || SchemaConstants.isReplicatedSystemKeyspace(keyspace) : String.format("Table %s.%s is not a system table", keyspace, table);
