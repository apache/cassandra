...
public final class DistributedMetadataLogKeyspace
{
    ...
    {
        return KeyspaceMetadata.create(SchemaConstants.METADATA_KEYSPACE_NAME, new KeyspaceParams(true, ReplicationParams.simpleMeta(1, knownDatacenters), ReplicationType.legacy), Tables.of(Log));
    }
