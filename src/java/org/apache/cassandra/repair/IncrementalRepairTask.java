...
public class IncrementalRepairTask extends AbstractRepairTask
{
    ...
    public Future<CoordinatedRepairResult> performUnsafe(ExecutorPlus executor) throws Exception
    {
        ...
        return coordinatorSession.execute(() -> runRepair(coordinator.state.id, true, executor, allRanges, coordinator.neighborsAndRanges.excludedDeadParticipants, coordinator.columnFamilyNames.toArray(new String[0])));
