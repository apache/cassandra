...
public class PrioritizedRepairPlan
{
     ...
     */
    public static List<PrioritizedRepairPlan> build(InetAddressAndPort endpoint, Map<String, List<String>> keyspacesToTableNames, AutoRepairConfig.RepairType repairType, Consumer<List<String>> orderFunc)
    {
        ...
        for (int priority : priorities)
        {
            ...
            for(String keyspaceName : keyspaceNames)
            {
               ...
               KeyspaceRepairPlan keyspaceRepairPlan = new KeyspaceRepairPlan(endpoint, keyspaceName, new ArrayList<>(tableNames));
     ...
     */
    static List<PrioritizedRepairPlan> buildSingleKeyspacePlan(InetAddressAndPort endpoint, AutoRepairConfig.RepairType repairType, String keyspaceName, String ... tableNames)
    {
        Map<String, List<String>> keyspaceMap = new HashMap<>();
        keyspaceMap.put(keyspaceName, Arrays.asList(tableNames));
        return build(endpoint, keyspaceMap, repairType, (l) -> {});
    }
