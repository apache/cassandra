...
public class AutoRepairConfig implements Serializable
{
    ...
    public enum RepairType implements Serializable
    {
        ...
        RepairType()
        {
            this.configName = name().toLowerCase(Locale.US);
        }
        ...
        {
            return RepairType.valueOf(Objects.requireNonNull(repairTypeStr, "repairTypeStr cannot be null").toUpperCase(Locale.US));
        }
    }
    ...
    {
        getOptions(repairType).abort_auto_repair_after = new DurationSpec.LongSecondsBound(interval);
    }
    ...
    public static class Options implements Serializable
    {
        ...
        private static Map<AutoRepairConfig.RepairType, Options> initializeDefaultOptions()
        {
            ...
            options.put(RepairType.PAXOS_CLEANUP, getDefaultOptions());
            options.put(RepairType.BOOTSTRAP, getDefaultOptions());
        ...
        protected static Options getDefaultOptions()
        {
            ...
            opts.materialized_view_repair_enabled = true;
        ...
        public volatile Integer repair_max_retries;
        // Backoff time before retrying a repair session.
        public volatile DurationSpec.LongSecondsBound repair_retry_backoff;
