 ...
 * data-center-local address, based on the reconnection trick used in
 * {@link Ec2MultiRegionSnitch}. The configuration file,
 * {@code cassandra-topology.yaml}, is checked periodically for updates.
 * </p>
 */
public class YamlFileNetworkTopologySnitch
    ...
    /**
     * Returns the name of the rack for the endpoint, or {@code UNKNOWN} if not
     * known.
     * 
     * @return the name of the data center for the endpoint, or {@code UNKNOWN}
     *         if not known
     */
    @Override
    ...
    /**
     * Returns the name of the data center for the endpoint, or {@code UNKNOWN}
     * if not known.
     * 
     * @return the name of the data center for the endpoint, or {@code UNKNOWN}
     *         if not known
    ...
    /**
     * Returns the preferred non-broadcast address for the endpoint, or null if
     * none was specified.
     * <p>
     ...
     * @return the preferred non-broadcast address for the endpoint, or null if
     *         none was specified
     */
    ...
    /**
     * Reconnects to the endpoint through the preferred non-broadcast address if
     * necessary.
     * <p>
     ...
     * necessary.
     * <p>
     * A reconnect is performed to {@code preferredAddress} if the
     * {@code preferredAddress} argument is not null.
     * </p>
     * <p>
     * This method is only meant to be called by
     * {@link #reconnectViaPreferredAddress(InetAddress)}, but is declared to
    ...
    public synchronized void gossiperStarting() {
        ...
        final IEndpointStateChangeSubscriber escs = new IEndpointStateChangeSubscriber() {
             ...
             * preferred non-broadcast address if necessary.
             * 
             * @param endpoint
             *            the endpoint's broadcast address
             * @param epState
