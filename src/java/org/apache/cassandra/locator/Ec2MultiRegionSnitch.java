...
public class Ec2MultiRegionSnitch extends Ec2Snitch
{
    ...
    public void gossiperStarting()
    {
        ...
        Gossiper.instance.addLocalApplicationState(ApplicationState.INTERNAL_ADDRESS_AND_PORT, StorageService.instance.valueFactory.internalAddressAndPort(address.getHostAddress(true)));
