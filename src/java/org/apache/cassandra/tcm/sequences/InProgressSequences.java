...
public class InProgressSequences implements MetadataValue<InProgressSequences>, Iterable<MultiStepOperation<?>>
{
    ...
    public static void finishInProgressSequences(MultiStepOperation.SequenceKey sequenceKey, boolean onlyStartup)
    {
        ...
        while (true)
        {
            ...
            if (sequence == null)
                break;
            if (onlyStartup && !sequence.finishDuringStartup())
                break;
            if (isLeave(sequence))
