...
public class ClusterMetadata
{
    ...
    {
        return new ClusterMetadata(epoch, period, lastInPeriod, partitioner, schema, directory, tokenMap, placements, accordTables, accordFastPath, lockedRanges, inProgressSequences, consensusMigrationState, extensions);
    }
    ...
    public static class Transformer
    {
        ...
        public Transformed build()
        {
            ...
            return new Transformed(new ClusterMetadata(base.metadataIdentifier,epoch,
                                                       period,
                                                       lastInPeriod,
                                                       partitioner,
                                                       schema,
