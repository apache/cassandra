...
public class ClusterMetadata
{
    ...
    {
        return new ClusterMetadata(epoch, period, lastInPeriod, partitioner, schema, directory, tokenMap, placements, accordFastPath, lockedRanges, inProgressSequences, consensusMigrationState, extensions);
    }
