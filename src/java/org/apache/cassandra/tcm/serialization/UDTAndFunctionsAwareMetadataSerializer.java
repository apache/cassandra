...
public interface UDTAndFunctionsAwareMetadataSerializer<T>
{
     ...
     * @param functions collection of user defined functions required to deserialize the instance
     * @param version protocol version
     * @return the type that was deserialized
     * @throws IOException if deserialization fails
     */
    public T deserialize(DataInputPlus in, Types types, UserFunctions functions, Version version) throws IOException;
