...
abstract class AbstractQueryPager<T extends ReadQuery> implements QueryPager
{
    ...
    @Override
    public PartitionIterator fetchPage(PageSize pageSize, ConsistencyLevel consistency, ClientState clientState, Dispatcher.RequestTime requestTime)
    {
    ...
    {
        private UnfilteredPagerTransformation(DataLimits pageLimits, long nowInSec)
        {
    ...
    {
        private RowPagerTransformation(DataLimits pageLimits, long nowInSec)
        {
            super(pageLimits, nowInSec);
        }
    ...
    private abstract class PagerTransformation<T extends Unfiltered> extends Transformation<BaseRowIterator<T>>
    {
        ...
        private PagerTransformation(DataLimits pageLimits, long nowInSec)
        {
