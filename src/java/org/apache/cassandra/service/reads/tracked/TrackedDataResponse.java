...
// TODO: replace TrackedReadResponse
public class TrackedDataResponse
{
    ...
    {
        @Override
        public void serialize(TrackedDataResponse t, DataOutputPlus out, int version) throws IOException
        {
        ...
        @Override
        public long serializedSize(TrackedDataResponse t, int version)
        {
            throw new UnsupportedOperationException("TODO");
        }
    };
