...
public class DigestResolver<E extends Endpoints<E>, P extends ReplicaPlan.ForRead<E>> extends ResponseResolver<E, P>
{
    ...
    public DigestResolver(ReadCommand command, ReplicaPlan.Shared<E, P> replicaPlan, QueryState queryState)
    {
    ...
    public PartitionIterator getData()
    {
        ...
        else
        {
            ...
            DataResolver<E, P> dataResolver
                    = new DataResolver<>(command, replicaPlan, NoopReadRepair.instance, queryState);
