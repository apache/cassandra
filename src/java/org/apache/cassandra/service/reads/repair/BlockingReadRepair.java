        ...
        extends AbstractReadRepair<E, P>
{
    ...
    @Override
    public void repairPartition(DecoratedKey dk, Map<Replica, Mutation> mutations, ReplicaPlan.ForReadRepair writePlan)
    {
    ...
    public void repairPartitionDirectly(ReadCoordinator readCoordinator, DecoratedKey dk, Map<Replica, Mutation> mutations, ForReadRepair writePlan)
    {
