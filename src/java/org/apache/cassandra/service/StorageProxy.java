...
public class StorageProxy implements StorageProxyMBean
{
    ...
    throws UnavailableException, OverloadedException, WriteTimeoutException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                final Collection<InetAddressAndPort> batchlogEndpoints = Collections.singleton(FBUtilities.getBroadcastAddressAndPorts());
    ...
    private static InetAddressAndPort findSuitableEndpoint(String keyspaceName, DecoratedKey key, String localDataCenter, ConsistencyLevel cl) throws UnavailableException
    {
        ...
        List<InetAddressAndPort> endpoints = StorageService.instance.getLiveNaturalEndpoints(keyspace, key);
        if (endpoints.isEmpty())
            // TODO have a way to compute the consistency level
            throw new UnavailableException(cl, cl.blockFor(keyspace), 0);

        List<InetAddressAndPort> localEndpoints = new ArrayList<>();
