...
public class WriteThresholdMapSerializer implements IVersionedSerializer<Map<TableId, Long>>
{
    public static final WriteThresholdMapSerializer serializer = new WriteThresholdMapSerializer();

    @Override
    public void serialize(Map<TableId, Long> t, DataOutputPlus out, int version) throws IOException
    {
