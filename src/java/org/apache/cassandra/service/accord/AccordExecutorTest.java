...
class AccordExecutorTest extends AccordExecutor
{
    ...
    public AccordExecutorTest(int executorId, String name, AccordStateCacheMetrics metrics, Agent agent)
    {
        this(executorId, name, metrics, Stage.READ.executor(), Stage.MUTATION.executor(), Stage.READ.executor(), agent);
    }

    public AccordExecutorTest(int executorId, String name, AccordStateCacheMetrics metrics, ExecutorPlus loadExecutor, ExecutorPlus saveExecutor, ExecutorPlus rangeLoadExecutor, Agent agent)
    {
        this(executorId, name, metrics, loadExecutor::submit, saveExecutor::submit, rangeLoadExecutor::submit, agent);
    }

    public AccordExecutorTest(int executorId, String name, AccordStateCacheMetrics metrics, ExecutorFunction loadExecutor, ExecutorFunction saveExecutor, ExecutorFunction rangeLoadExecutor, Agent agent)
    {
        this(new ReentrantLock(), executorId, name, metrics, loadExecutor, saveExecutor, rangeLoadExecutor, agent);
    }

    private AccordExecutorTest(ReentrantLock lock, int executorId, String name, AccordStateCacheMetrics metrics, ExecutorFunction loadExecutor, ExecutorFunction saveExecutor, ExecutorFunction rangeLoadExecutor, Agent agent)
    {
