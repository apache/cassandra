...
public class EndpointMapping implements AccordEndpointMapper
{
    public static class Updateable implements AccordEndpointMapper
    {
    ...
    public static Builder builder(long epoch)
    {
