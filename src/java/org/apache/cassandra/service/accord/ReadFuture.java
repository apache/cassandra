...
public class ReadFuture implements Future<Data>
{
    ...
    @Override
    public <T> Future<T> andThenAsync(Function<? super Data, ? extends Future<T>> andThen)
    {
        throw new UnsupportedOperationException("git rebase: this goes away once AsyncChain comes in");
    }

    @Override
    public <T> Future<T> andThenAsync(Function<? super Data, ? extends Future<T>> andThen, Executor executor)
    {
        throw new UnsupportedOperationException("git rebase: this goes away once AsyncChain comes in");
    }
