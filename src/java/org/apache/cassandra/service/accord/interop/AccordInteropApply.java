...
public class AccordInteropApply extends Apply implements Command.TransientListener
{
    ...
    {
        @Override
        public Apply create(Kind kind, Id to, Topologies participates, Topologies executes, TxnId txnId, FullRoute<?> route, Txn txn, Timestamp executeAt, Deps deps, Writes writes, Result result)
        {
    ...
    private AccordInteropApply(Kind kind, Id to, Topologies participates, Topologies executes, TxnId txnId, FullRoute<?> route, Txn txn, Timestamp executeAt, Deps deps, Writes writes, Result result)
    {
