...
abstract class AccordExecutorAbstractLockLoop extends AccordExecutor
{
    ...
    AccordExecutorAbstractLockLoop(Lock lock, int executorId, AccordStateCacheMetrics metrics, ExecutorFunctionFactory loadExecutor, ExecutorFunctionFactory saveExecutor, ExecutorFunctionFactory rangeLoadExecutor, Agent agent)
    {
