...
public class AccordConfigurationService extends AbstractConfigurationService<AccordConfigurationService.EpochState, AccordConfigurationService.EpochHistory> implements AccordEndpointMapper, AccordSyncPropagator.Listener, Shutdownable
{
    ...
    private final MetadataChangeListener listener = new MetadataChangeListener();
...
//SubstituteLogger.java:169 - DEBUG [node5_Messaging-EventLoop-3-1] node5 2024-12-04 20:15:07,842 HeapUtils.java:133 - Heap dump creation on uncaught exceptions is disabled.