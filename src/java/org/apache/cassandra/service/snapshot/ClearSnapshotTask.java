...
public class ClearSnapshotTask implements Callable<Void>
{
    ...
    public ClearSnapshotTask(Predicate<TableSnapshot> predicateForToBeCleanedSnapshots, boolean deleteData)
    {
    ...
    public Void call()
    {
        ...
        toRemove.forEach(SnapshotManager.instance.getSnapshots()::remove);
