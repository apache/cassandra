...
/**
 * NoOpRequestThrottler implements the IRequestThrottler interface and allows all read and write requests without throttling any of them.
 */
public class NoOpRequestThrottler implements IRequestThrottler
{
    public NoOpRequestThrottler(Map<String, String> parameters) {}
