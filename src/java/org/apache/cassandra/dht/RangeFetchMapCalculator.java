...
public class RangeFetchMapCalculator
{
    ...
    public RangeFetchMapCalculator(Multimap<Range<Token>, InetAddressAndPort> rangesWithSources, Collection<RangeStreamer.ISourceFilter> sourceFilters, String keyspace)
    {
