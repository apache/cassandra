...
public class RangeStreamer
{
    ...
    public void addRanges(String keyspaceName, Collection<Range<Token>> ranges)
    {
        ...
        Multimap<InetAddressAndPort, Range<Token>> rangeFetchMap = useStrictSource ? getRangeFetchMap(rangesForKeyspace, sourceFilters, keyspaceName, useStrictConsistency) :
