 ...
 */
public class ReversedLocalLongPartitioner implements IPartitioner
{
    public static ReversedLocalLongPartitioner instance = new ReversedLocalLongPartitioner();
    private static final ReversedLocalLongToken MIN_TOKEN = new ReversedLocalLongToken(Long.MIN_VALUE);
    private static final long HEAP_SIZE = ObjectSizes.measure(MIN_TOKEN);

    private ReversedLocalLongPartitioner() {}
    ...
    public Token getToken(ByteBuffer key)
    {
        ...
        return new ReversedLocalLongToken(Long.MAX_VALUE - longKey);
    }
    ...
    private final Token.TokenFactory tokenFactory = new Token.TokenFactory()
    {
        public Token fromComparableBytes(ByteSource.Peekable comparableBytes, ByteComparable.Version version)
        {
            ...
            return new ReversedLocalLongToken(tokenData);
        }

        public ByteBuffer toByteArray(Token token)
        {
            ReversedLocalLongToken longToken = (ReversedLocalLongToken) token;
            return ByteBufferUtil.bytes(longToken.token);
        }

        public Token fromByteArray(ByteBuffer bytes)
        {
            return new ReversedLocalLongToken(ByteBufferUtil.toLong(bytes));
        }
        ...
        {
            return new ReversedLocalLongToken(Long.parseLong(string));
        }
    };
    ...
    private static class ReversedLocalLongToken extends Token
    {
        private final long token;

        public ReversedLocalLongToken(long token)
        {
            this.token = token;
        }
        @Override
        ...
        {
            return ReversedLocalLongPartitioner.instance;
        }
        ...
        {
            return Long.compare(token, ((ReversedLocalLongToken)o).token);
        }
        ...
        public boolean equals(Object o)
        {
            ...
            if (!(o instanceof ReversedLocalLongToken)) return false;
            ReversedLocalLongToken that = (ReversedLocalLongToken) o;
