                                ...
                                BiFunction<Boolean, byte[], Response> messageToSendBasedOnNegotiation)
    {
        ...
        try
        {
            ...
            if (negotiator.isComplete())
            {
                ...
                ClientMetrics.instance.markAuthSuccess(user.getAuthenticationMode().toString());
        ...
        {
            ClientMetrics.instance.markAuthFailure(negotiator.getAuthenticationMode().toString());
