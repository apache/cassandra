...
public class OutboundTcpConnectionPool
{
    ...
    private final InetAddressAndPort id;
    ...
    private InetAddressAndPort resetEndpoint;
    private ConnectionMetrics metrics;

    // back-pressure state linked to this connection:
    private final BackPressureState backPressureState;

    OutboundTcpConnectionPool(InetAddressAndPort remoteEp, BackPressureState backPressureState)
    {
        id = remoteEp;
     ...
     * @param remoteEP
     */
    public void reset(InetAddressAndPort remoteEP)
    {
    ...
    public static Socket newSocket(InetAddressAndPort endpoint) throws IOException
    {
    ...
    public static int portFor(InetAddressAndPort endpoint)
    {
    ...
    public static boolean isEncryptedChannel(InetAddressAndPort address)
    {
