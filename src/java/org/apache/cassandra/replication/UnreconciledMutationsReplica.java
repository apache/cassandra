...
class UnreconciledMutationsReplica implements UnreconciledMutations
{
    ...
    @Override
    public boolean collect(Token token, TableId tableId, boolean includePending, Offsets into)
    {
    ...
    @Override
    public boolean collect(AbstractBounds<PartitionPosition> range, TableId tableId, boolean includePending, Offsets into)
    {
