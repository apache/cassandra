...
public abstract class ForwardedWriteHandler implements RequestCallback<NoPayload>
{
    private static final Logger logger = LoggerFactory.getLogger(ForwardedWriteHandler.class);

    // Leader just needs to acknowledge propagation for its own log, not for client consistency level
    public static class Leader extends ForwardedWriteHandler
    {
