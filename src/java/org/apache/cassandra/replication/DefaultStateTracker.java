...
/**
 * Default implementation of SegmentStateTracker that tracks the memtable-sstable flush states of commit log segment offsets.
 *
 ...
 */
public class DefaultStateTracker implements SegmentStateTracker
{
    final long segmentId;

    private final Map<TableId, IntervalState> states = new HashMap<>(32);

    public DefaultStateTracker(long segmentId)
    {
