...
public abstract class CassandraIndex implements Index
{
                        ...
                        WriteContext ctx)
    {
        ...
        indexCfs.getWriteHandler().writeNested(upd, ctx, UpdateTransaction.NO_OP);
    ...
    private void buildBlocking()
    {
             ...
             Refs<SSTableReader> sstables = viewFragment.refs)
        {
            ...
            Future<?> future = CompactionManager.instance.submitIndexBuild(builder).addCallback((r, t) -> builder.close());
