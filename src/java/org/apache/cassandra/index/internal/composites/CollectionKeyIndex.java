...
public class CollectionKeyIndex extends CollectionKeyIndexBase
{
    ...
    public static AbstractType<?> getIndexedValueType(ColumnMetadata indexedColumn)
    {
        assert indexedColumn.type.isCollection() && ((CollectionType)indexedColumn.type).kind == Kind.MAP;
