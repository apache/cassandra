 ...
 */
public interface SegementOrdering
{
    /**
     * Reorder the results from a single component; sstable is null
     * if the component is a memtable.
     */
    public abstract KeyRangeIterator reorderOneComponent(QueryContext context, KeyRangeIterator iterator, Expression exp, int limit) throws IOException;
}
