...
@NotThreadSafe
public class SSTableRowIdsRangeIterator extends KeyRangeIterator<Long>
{
     ...
     */
    public SSTableRowIdsRangeIterator(IndexContext indexContext, IndexSegmentSearcherContext searcherContext)
    {
        super(searcherContext.minimumSSTableRowId, searcherContext.maximumSSTableRowId, searcherContext.count());
