...
public class KeyStoreWriter implements Closeable
{
     ...
     *
     * @param keysDataComponent component builder for the prefix-compressed keys data
    ...
    {
        this.componentName = keysDataComponent.fileNamePart();
        this.metadataWriter = metadataWriter;
        this.blockShift = blockShift;
        this.blockMask = (1 << this.blockShift) - 1;
        this.clustering = clustering;
        this.keysOutput = keysDataComponent.openOutput();
        SAICodecUtils.writeHeader(this.keysOutput);
