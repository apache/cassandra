...
public interface MemtableOrdering
{
     ...
     */
    public abstract RangeIterator<PrimaryKey> reorderOneComponent(QueryContext context, RangeIterator<PrimaryKey> iterator, Expression exp, int limit) throws IOException;
}
