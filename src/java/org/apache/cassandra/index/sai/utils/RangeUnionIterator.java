...
public class RangeUnionIterator<T extends Comparable> extends RangeIterator<T>
{
    ...
    public static <T extends Comparable> RangeIterator<T> build(Iterable<RangeIterator<T>> tokens)
    {
