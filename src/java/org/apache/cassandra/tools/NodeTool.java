...
public class NodeTool
{
    ...
    public int execute(String... args)
    {
        List<Class<? extends NodeToolCmdRunnable>> commands = newArrayList(
                ...
                CheckLocalMVBackfillStatus.class,
                ClientStats.class,
                Compact.class,
                ...
                DisableAuditLogRoleFilter.class,
                ...
                DisableSampledQueryEventLogger.class,
                Drain.class,
                ...
                EnableSampledQueryEventLogger.class,
                ...
                GetGossipServiceCacheMismatchConfig.class,
                GetLCSEnforcementLevel.class,
                GetClearSnapshotFilesLogEnabled.class,
                ...
                GetInboundStreamThroughput.class,
                GetInterDCStreamThroughput.class,
                GetLoggingLevels.class,
                GetForceDisableTrace.class,
                GetGuardrailsConfig.class,
                GetViewKeyRebuildConfig.class,
                GetQueryAnalyticsConfig.class,
                GetClientLibsEnforcementLevel.class,
                GetAllowedClientLibDrivers.class,
                GetMaxHintWindow.class,
                GetMaxWaitTimeInTransportQueue.class,
                ...
                GetIgnoreRepairedAtEnabled.class,
                GetUseWeightBasedPreparedStatementsCacheEnabled.class,
                GossipInfo.class,
                Import.class,
                Info.class,
                IsMVBackfillFinished.class,
                ...
                SetClearSnapshotFilesLogEnabled.class,
                SetColumnIndexSize.class,
                SetNativeTransportThrowOnOverload.class,
                GetNativeTransportThrowOnOverload.class,
                SetCompactionThreshold.class,
                SetCompactionThroughput.class,
                SetDirectMaterializedViewModification.class,
                SetLCSEnforcementLevel.class,
                SetForceDisableTrace.class,
                ...
                SetViewKeyRebuildConfig.class,
                SetQueryAnalyticsConfig.class,
                SetClientLibsEnforcementLevel.class,
                SetAllowedClientLibDrivers.class,
                SetHintedHandoffThrottleInKB.class,
                SetInboundStreamThroughput.class,
                SetInterDCStreamThroughput.class,
                SetLoggingLevel.class,
                SetMaxHintWindow.class,
                SetMaxWaitTimeInTransportQueue.class,
                SetNativeTransportTimeoutThreshold.class,
                SetIgnoreRepairedAtEnabled.class,
                SetPersistPreparedStatementsEnabled.class,
