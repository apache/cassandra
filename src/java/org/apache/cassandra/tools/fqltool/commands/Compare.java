...
public class Compare implements Runnable
{
    ...
    @Option(title = "queries", name = { "--queries"}, description = "Where to read the queries - should be produced by the replay command --store-queries to make sure they are in the same order")
