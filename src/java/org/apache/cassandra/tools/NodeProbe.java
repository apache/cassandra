...
public class NodeProbe implements AutoCloseable
{
    ...
    public void forceNewerGossipGeneration()
    {
        gossProxy.forceNewerGeneration();
    }
    ...
    {
        ssProxy.setNativeTransportThrowOnOverload(throwOnOverload);
    }
    ...
    {
        ssProxy.rebuild(sourceDc, keyspace, tokens, specificSources, refetchData);
    }
    ...
    {
        rateLimiterProxy.setPendingNativeTransportThresholdOneMinute(pendingNativeTransportThresholdOneMinute);
    }
