...
public class Status extends NodeToolCmd
{
    ...
    public void execute(NodeProbe probe)
    {
        ...
        for (Map.Entry<String, SetHostStat> dc : dcs.entrySet())
        {
            ...
            for (InetAddress endpoint : hostToTokens.keySet())
            {
                ...
                printNode(endpoint.getHostAddress(), owns, tokens, hasEffectiveOwns, isTokenPerNode, out);
            }
        }
    ...
    private void printNodesHeader(boolean hasEffectiveOwns, boolean isTokenPerNode, PrintStream out)
    {
    ...
    private void printNode(String endpoint, Float owns, List<HostStat> tokens, boolean hasEffectiveOwns, boolean isTokenPerNode, PrintStream out)
    {
