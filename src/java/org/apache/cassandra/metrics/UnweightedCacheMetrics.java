 ...
 */
public class UnweightedCacheMetrics
{
    /**
    ...
    {
        this(cache, new DefaultNameFactory("UnweightedCache", type));
    }

    protected UnweightedCacheMetrics(UnweightedCacheSize cache, MetricNameFactory metricNameFactory)
    {
