...
public class AutoRepairMetrics
{
    ...
    protected static class AutoRepairMetricsFactory implements MetricNameFactory
    {
        ...
        {
            this.repairType = repairType.toString().toLowerCase(Locale.US);
        }
        ...
        public CassandraMetricsRegistry.MetricName createMetricName(String metricName)
        {
            ...
            return new CassandraMetricsRegistry.MetricName(DefaultNameFactory.GROUP_NAME, TYPE.toLowerCase(Locale.US),
