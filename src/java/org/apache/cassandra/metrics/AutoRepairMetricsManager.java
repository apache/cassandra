...
{
    private static final Map<RepairType, AutoRepairMetricsV2> metrics = new ConcurrentHashMap<>();

    public static AutoRepairMetricsV2 getMetrics(RepairType repairType)
    {
        return metrics.computeIfAbsent(repairType, k -> new AutoRepairMetricsV2(repairType));
    }
}
