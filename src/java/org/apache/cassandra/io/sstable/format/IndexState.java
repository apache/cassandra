...
{
    private final AbstractSSTableIterator<BigTableRowIndexEntry>.Reader reader;
    ...
    public IndexState(AbstractSSTableIterator<BigTableRowIndexEntry>.Reader reader,
