...
public class RangeAwareSSTableWriter implements SSTableMultiWriter
{
    ...
    public RangeAwareSSTableWriter(ColumnFamilyStore cfs, long estimatedKeys, long repairedAt, TimeUUID pendingRepair, boolean isWitness, SSTableFormat<?, ?> format, int sstableLevel, long totalSize, LifecycleNewTracker lifecycleNewTracker, SerializationHeader header) throws IOException
    {
        ...
        if (boundaries == null)
        {
            ...
            currentWriter = cfs.createSSTableMultiWriter(desc, estimatedKeys, repairedAt, pendingRepair, isWitness, null, sstableLevel, header, lifecycleNewTracker);
        }
    }
