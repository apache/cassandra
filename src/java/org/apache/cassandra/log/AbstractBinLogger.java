...
public abstract class AbstractBinLogger<T> implements ILogger<T>
{
    ...
    public AbstractBinLogger(Map<String, String> options)
    {
        ...
        keyValueSeparator = options.getOrDefault("key_value_separator", DEFAULT_KEY_VALUE_SEPARATOR);
        fieldSeparator = options.getOrDefault("field_separator", DEFAULT_FIELD_SEPARATOR);
    }
