...
final class HintsDispatcher implements AutoCloseable
{
    ...
    private Callback sendHint(Hint hint)
    {
        ...
        if (accordHintMutation != null)
        {
            ...
            accordTxnResult = accordHintMutation != null ? ConsensusMigrationMutationHelper.instance().mutateWithAccordAsync(cm, accordHintMutation, null, txnStartNanoTime) : null;
        }
