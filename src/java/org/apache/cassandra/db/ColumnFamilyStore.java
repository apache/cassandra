...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean
{
    ...
    */
     ...
     */
    public TableSnapshot snapshotWithoutFlush(String snapshotName, Predicate<SSTableReader> predicate, boolean ephemeral, CassandraDuration ttl, RateLimiter rateLimiter, Instant creationTime)
    {
    ...
    protected TableSnapshot createSnapshot(String tag, boolean ephemeral, CassandraDuration ttl, Set<SSTableReader> sstables, Instant creationTime) {
     ...
     */
    public TableSnapshot snapshot(String snapshotName, boolean skipFlush, CassandraDuration ttl, RateLimiter rateLimiter, Instant creationTime)
    {
     ...
     * @param creationTime time when this snapshot was taken
     */
    public TableSnapshot snapshot(String snapshotName, Predicate<SSTableReader> predicate, boolean ephemeral, boolean skipFlush, CassandraDuration ttl, RateLimiter rateLimiter, Instant creationTime)
    {
        if (!skipFlush)
        {
            forceBlockingFlush();
