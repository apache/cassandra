...
public interface GuardrailsConfigProvider
{
    ...
    static final GuardrailsConfigProvider instance = CUSTOM_GUARDRAILS_CONFIG_PROVIDER_CLASS.getString() == null
                                                     ? new Default()
                                                     : build(CUSTOM_GUARDRAILS_CONFIG_PROVIDER_CLASS.getString());
