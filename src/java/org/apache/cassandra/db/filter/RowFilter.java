...
public class RowFilter implements Iterable<RowFilter.Expression>
{
    ...
    protected Transformation<BaseRowIterator<?>> filter(TableMetadata metadata, long nowInSec)
    {
        ...
        return new Transformation<>()
        {
            ...
            {
                //CompiledStatement{cql='SELECT pk1, pk2, pk3, ck1, ck2, ck3, s1, v1, v2, v3, writetime(s1), writetime(v1), writetime(v2), writetime(v3) FROM distributed_test_keyspace.tbl1 WHERE pk1 = ? AND pk2 = ? AND pk3 = ? AND ck1 > ? AND v2 > ? AND v3 > ? AND v1 = ?;', 
                // bindings=498365490L,"ZHHyABdiABdiABdiABdiABdiLgtXHuFO132462222389241186185811081241042241942118248114222548",10190L,
                ...
                // 4437113781045784766L,-8292973307042192125L,""}
