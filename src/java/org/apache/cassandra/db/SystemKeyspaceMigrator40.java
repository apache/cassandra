...
public class SystemKeyspaceMigrator40
{
    ...
    {
        migrateTable(SystemKeyspace.LEGACY_SSTABLE_ACTIVITY,
                     ...
                     Collections.singletonList(new Object[]{ row.getString("keyspace_name"),
                                                             ...
                                                             new SequenceBasedSSTableUniqueIdentifier(row.getInt("generation")).asBytes(),
    ...
    @VisibleForTesting
    static void migrateTable(String oldName, String newName, String[] columns, Function<UntypedResultSet.Row, Collection<Object[]>> transformation)
    {
