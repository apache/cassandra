    ...
    public static class Reconciler implements UpdateFunction<ColumnData, ColumnData>, AutoCloseable
    {
        ...
        public ColumnData merge(ColumnData existing, ColumnData update)
        {
            ...
            else
            {
                ...
                // The merged complex column carries maxComplexDeletion in place of the existing column's deletion,
                // which is counted as owned (ComplexColumnData.unsharedHeapSizeExcludingData); account that swap.
