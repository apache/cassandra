...
/**
 * A utility class to split the given {@code #UnfilteredRowIterator} into smaller chunks each
 ...
 *
 * A subsequent {@code #next} call will exhaust the previously returned iterator before computing the next,
