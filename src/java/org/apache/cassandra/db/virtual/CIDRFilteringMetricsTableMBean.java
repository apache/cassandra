...
public interface CIDRFilteringMetricsTableMBean
{
     ...
     * @return map of rows, map's key is metric name, map's value is metric value
     */
    public Map<String, Long> getCountsMetricsFromVtable();

    /**
     * Retreive rows from CIDR filtering latency metrics virtual table
     * @return map of rows, map's key is metric name, map's values are latency percentiles
     */
