...
public class GuardrailValuesTable extends AbstractMutableVirtualTable
{
    ...
    public GuardrailValuesTable(String keyspace)
    {
        super(TableMetadata.builder(keyspace, TABLE_NAME)
                           ...
                           .addRegularColumn(VALUE_COLUMN, SetType.getInstance(UTF8Type.instance, false))
                           .build());
    }
    ...
    public DataSet data()
    {
        ...
        for (Map.Entry<String, List<Method>> entry : cache.getValuesGetters().entrySet())
            result.row(entry.getKey()).column(VALUE_COLUMN, cache.invoke(entry.getValue().get(0)));
    ...
    public DataSet data(DecoratedKey partitionKey)
    {
        ...
        List<Method> methods = cache.getValuesGetters().get(guardrailname);
