...
/**
 * The {@link org.apache.cassandra.db.virtual.model.MeterMetricRow} row metadata and data walker.
 *
 * @see org.apache.cassandra.db.virtual.model.MeterMetricRow
 */
public class MeterMetricRowWalker implements RowWalker<MeterMetricRow>
{
    @Override
    ...
    @Override
    public void visitRow(MeterMetricRow row, RowMetadataVisitor visitor)
    {
