...
public class Config
{
    ...
    public volatile DataStorageSpec.IntBytesBound secondary_index_rebuild_page_size = new DataStorageSpec.IntBytesBound(32, DataStorageSpec.DataStorageUnit.MEBIBYTES);
