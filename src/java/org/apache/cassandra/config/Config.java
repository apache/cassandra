...
public class Config
{
    ...
    /* When enabled, counter write metrics and detailed error logging are recorded */
    public volatile boolean track_counter_write_metrics = false;
    ...
    public DurationSpec.LongSecondsBound streaming_commit_latch_timeout = new DurationSpec.LongSecondsBound("0s");
    ...
    public boolean use_hintstage_for_hints = true;
    ...
    public boolean shadow_rows_tracking_enabled = false;
    ...
    /*default reporting is in syslog file, one can override this behavior
    ...
    public Long bad_query_write_max_partitionsize_in_bytes = 50 * 1024 * 1024L;

    public Integer bad_query_read_slow_local_latency_in_ms = 100;

    public Integer bad_query_write_slow_local_latency_in_ms = 100;

    public Integer bad_query_read_slow_coord_latency_in_ms = 200;

    public Integer bad_query_write_slow_coord_latency_in_ms = 200;
    ...
    // set this to be true to unmark SSTables from compacting in batch for index redistribution summary (CASSANDRA-20159)
    public boolean unmark_compacting_index_redistribution_in_batch_enabled = false;
    ...
    public volatile boolean counter_columns_enabled = true;
