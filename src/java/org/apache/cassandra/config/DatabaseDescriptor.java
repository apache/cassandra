...
public class DatabaseDescriptor
{
    ...
    */
    ...
    public static long getMaxInflightGlobalRequestsPayloadInBytes()
    {
        return conf.max_inflight_global_requests_payload_in_bytes;
    }

    public static void setMaxInflightGlobalRequestsPayloadInBytes(long maxInflightTotalRequestsPayloadInBytes)
    {
        conf.max_inflight_global_requests_payload_in_bytes = maxInflightTotalRequestsPayloadInBytes;
    }
