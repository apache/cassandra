...
public class GuardrailsOptions implements GuardrailsConfig
{
    ...
    private static Set<String> validateTableProperties(Set<String> properties, String name)
    {
        ...
        if (!diff.isEmpty())
            throw new IllegalArgumentException(format("Invalid values for %s: '%s' do not parse as valid table properties",
                                                      name, diff));
    ...
    private static Set<String> validateKeyspaceProperties(Set<String> properties, String name)
    {
        ...
        if (!diff.isEmpty()) 
            throw new IllegalArgumentException(format("Invalid values for %s: '%s' do not parse as valid keyspace properties",
                                                      name, diff));
