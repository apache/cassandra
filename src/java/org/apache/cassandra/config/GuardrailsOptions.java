...
public class GuardrailsOptions implements GuardrailsConfig
{
    ...
    public GuardrailsOptions(Config config)
    {
        ...
        validateMaxIntThreshold(config.zstd_compressor_level_warn_threshold, config.zstd_compressor_level_fail_threshold, "zstd_compressor_level");
    }
    ...
    {
        return config.zstd_compressor_level_warn_threshold;
    }

    @Override
    public int getZstdCompressorLevelFailThreshold()
    {
        return config.zstd_compressor_level_fail_threshold;
    }

    @Override
    public void setZstdCompressorLevelThreshold(int warn, int fail)
    {
        validateMaxIntThreshold(warn, fail, "zstd_compressor_level");
        updatePropertyWithLogging("zstd_compressor_level_warn_threshold",
                                  warn,
                                  () -> config.zstd_compressor_level_warn_threshold,
                                  x -> config.zstd_compressor_level_warn_threshold = x);
        updatePropertyWithLogging("zstd_compressor_level_fail_threshold",
                                  fail,
                                  () -> config.zstd_compressor_level_fail_threshold,
                                  x -> config.zstd_compressor_level_fail_threshold = x);
    }
